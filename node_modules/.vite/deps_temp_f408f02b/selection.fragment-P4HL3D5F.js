...
var includes = [clipPlaneFragmentDeclarationWGSL, clipPlaneFragmentWGSL];
for (const inc of includes) {
  if (!ShaderStore.IncludesShadersStoreWGSL[inc.name]) {
    ShaderStore.IncludesShadersStoreWGSL[inc.name] = inc.shader;
  }
}
var selectionPixelShaderWGSL = { name, shader };
export {
  selectionPixelShaderWGSL
};
//# sourceMappingURL=selection.fragment-P4HL3D5F.js.map
