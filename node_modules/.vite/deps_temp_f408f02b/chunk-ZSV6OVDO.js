        ...
        for (let rtIndex = 0; rtIndex < runtimeAnimations.length; rtIndex++) {
          ...
          if (rtAnim._targetPath === this._targetPath) {
            for (let i = 0; i < rtAnim._activeTargets.length; i++) {
              if (rtAnim._activeTargets[i] === target && rtAnim._originalValue[i] !== void 0) {
...
// node_modules/@babylonjs/core/Animations/animatable.pure.js
...
//# sourceMappingURL=chunk-ZSV6OVDO.js.map
