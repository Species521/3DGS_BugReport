...
var name = "iblDominantDirectionPixelShader";
var shader = `precision highp sampler2D;precision highp samplerCube;
...
var includes = [helperFunctions, importanceSampling, pbrBRDFFunctions, hdrFilteringFunctions];
for (const inc of includes) {
  if (!ShaderStore.IncludesShadersStore[inc.name]) {
    ShaderStore.IncludesShadersStore[inc.name] = inc.shader;
  }
}
var iblDominantDirectionPixelShader = { name, shader };

export {
  iblDominantDirectionPixelShader
};
//# sourceMappingURL=chunk-T4WGPKBD.js.map
