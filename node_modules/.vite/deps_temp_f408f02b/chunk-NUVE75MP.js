...
var shader = `uniform vec4 vEyePosition;uniform vec4 vPrimaryColor;
...
var backgroundFragmentDeclaration = { name, shader };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/intersectionFunctions.js
var name2 = "intersectionFunctions";
var shader2 = `float diskIntersectWithBackFaceCulling(vec3 ro,vec3 rd,vec3 c,float r) {float d=rd.y;if(d>0.0) { return 1e6; }
...
var intersectionFunctions = { name: name2, shader: shader2 };

// node_modules/@babylonjs/core/Shaders/background.fragment.js
var name3 = "backgroundPixelShader";
var shader3 = `#ifdef TEXTURELODSUPPORT
