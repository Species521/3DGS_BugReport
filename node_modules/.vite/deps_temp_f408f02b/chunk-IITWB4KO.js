...
// node_modules/@babylonjs/core/Bones/bone.pure.js
var _a;
...
// node_modules/@babylonjs/core/Animations/animationGroup.pure.js
...
function AnimationGroupMergeAnimationGroups(animationGroups, disposeSource = true, normalize = false, weight) {
...
function AnimationGroupParse(parsedAnimationGroup, scene, targetLookup) {
...
function AnimationGroupMakeAnimationAdditive(sourceAnimationGroup, referenceFrameOrOptions, range, cloneOriginal = false, clonedName) {
  let options;
...
function AnimationGroupClipKeys(sourceAnimationGroup, fromKey, toKey, name, dontCloneAnimations) {
...
function AnimationGroupClipKeysInPlace(animationGroup, fromKey, toKey, dontCloneAnimations) {
  return AnimationGroupClipInPlace(animationGroup, fromKey, toKey, dontCloneAnimations, false);
}
function AnimationGroupClipFrames(sourceAnimationGroup, fromFrame, toFrame, name, dontCloneAnimations) {
  const animationGroup = sourceAnimationGroup.clone(name || sourceAnimationGroup.name);
  return AnimationGroupClipFramesInPlace(animationGroup, fromFrame, toFrame, dontCloneAnimations);
}
function AnimationGroupClipFramesInPlace(animationGroup, fromFrame, toFrame, dontCloneAnimations) {
  return AnimationGroupClipInPlace(animationGroup, fromFrame, toFrame, dontCloneAnimations, true);
}
function AnimationGroupClipInPlace(animationGroup, start, end, dontCloneAnimations, useFrame = false) {
  let from = Number.MAX_VALUE;
  let to = -Number.MAX_VALUE;
  const targetedAnimations = animationGroup.targetedAnimations;
  for (let index = 0; index < targetedAnimations.length; index++) {
...
function RegisterAnimationGroup() {
  if (_Registered) {
    return;
  }
  _Registered = true;
...
export {
  ...
  TargetedAnimation,
  AnimationGroup,
  AnimationGroupMergeAnimationGroups,
  AnimationGroupParse,
  AnimationGroupMakeAnimationAdditive,
  AnimationGroupClipKeys,
  AnimationGroupClipKeysInPlace,
  AnimationGroupClipFrames,
  AnimationGroupClipFramesInPlace,
  AnimationGroupClipInPlace,
  RegisterAnimationGroup
};
//# sourceMappingURL=chunk-IITWB4KO.js.map
