...
} from "./chunk-2IW7GPWS.js";
import {
  bumpFragmentFunctionsWGSL
} from "./chunk-ZDXVD2Q3.js";
import {
  samplerFragmentDeclarationWGSL
} from "./chunk-IZEXF4LB.js";
import {
  bumpFragmentWGSL
} from "./chunk-HXS3RVRH.js";
import {
  lightFragmentWGSL
} from "./chunk-5KBU7UAT.js";
import {
...
var samplerFragmentAlternateDeclarationWGSL = { name, shader };

// node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrFragmentSamplersDeclaration.js
var name2 = "pbrFragmentSamplersDeclaration";
var shader2 = `#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
var pbrFragmentSamplersDeclarationWGSL = { name: name2, shader: shader2 };

// node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockAlbedoOpacity.js
var name3 = "pbrBlockAlbedoOpacity";
var shader3 = `struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
var pbrBlockAlbedoOpacityWGSL = { name: name3, shader: shader3 };

// node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockReflectivity.js
var name4 = "pbrBlockReflectivity";
var shader4 = `struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
var pbrBlockReflectivityWGSL = { name: name4, shader: shader4 };

// node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockAmbientOcclusion.js
var name5 = "pbrBlockAmbientOcclusion";
var shader5 = `struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
var pbrBlockAmbientOcclusionWGSL = { name: name5, shader: shader5 };

// node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockAlphaFresnel.js
var name6 = "pbrBlockAlphaFresnel";
var shader6 = `#ifdef ALPHAFRESNEL
...
var pbrBlockAlphaFresnelWGSL = { name: name6, shader: shader6 };

// node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockAnisotropic.js
var name7 = "pbrBlockAnisotropic";
var shader7 = `#ifdef ANISOTROPIC
...
var pbrBlockAnisotropicWGSL = { name: name7, shader: shader7 };

// node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockReflection.js
var name8 = "pbrBlockReflection";
var shader8 = `#ifdef REFLECTION
...
var pbrBlockReflectionWGSL = { name: name8, shader: shader8 };

// node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockSheen.js
var name9 = "pbrBlockSheen";
var shader9 = `#ifdef SHEEN
...
var pbrBlockSheenWGSL = { name: name9, shader: shader9 };

// node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockClearcoat.js
var name10 = "pbrBlockClearcoat";
var shader10 = `struct clearcoatOutParams
...
var pbrBlockClearcoatWGSL = { name: name10, shader: shader10 };

// node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockIridescence.js
var name11 = "pbrBlockIridescence";
var shader11 = `struct iridescenceOutParams
...
var pbrBlockIridescenceWGSL = { name: name11, shader: shader11 };

// node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockSubSurface.js
var name12 = "pbrBlockSubSurface";
var shader12 = `struct subSurfaceOutParams
...
var pbrBlockSubSurfaceWGSL = { name: name12, shader: shader12 };

// node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockNormalFinal.js
var name13 = "pbrBlockNormalFinal";
var shader13 = `#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
var pbrBlockNormalFinalWGSL = { name: name13, shader: shader13 };

// node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockLightmapInit.js
var name14 = "pbrBlockLightmapInit";
var shader14 = `#ifdef LIGHTMAP
...
var pbrBlockLightmapInitWGSL = { name: name14, shader: shader14 };

// node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockGeometryInfo.js
var name15 = "pbrBlockGeometryInfo";
var shader15 = `var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
var pbrBlockGeometryInfoWGSL = { name: name15, shader: shader15 };

// node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockReflectance.js
var name16 = "pbrBlockReflectance";
var shader16 = `#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
var pbrBlockReflectanceWGSL = { name: name16, shader: shader16 };

// node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockDirectLighting.js
var name17 = "pbrBlockDirectLighting";
var shader17 = `var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
var pbrBlockDirectLightingWGSL = { name: name17, shader: shader17 };

// node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockFinalLitComponents.js
var name18 = "pbrBlockFinalLitComponents";
var shader18 = `aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
var pbrBlockFinalLitComponentsWGSL = { name: name18, shader: shader18 };

// node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockFinalUnlitComponents.js
var name19 = "pbrBlockFinalUnlitComponents";
var shader19 = `var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
var pbrBlockFinalUnlitComponentsWGSL = { name: name19, shader: shader19 };

// node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockFinalColorComposition.js
var name20 = "pbrBlockFinalColorComposition";
var shader20 = `var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
var pbrBlockFinalColorCompositionWGSL = { name: name20, shader: shader20 };

// node_modules/@babylonjs/core/ShadersWGSL/ShadersInclude/pbrBlockPrePass.js
var name21 = "pbrBlockPrePass";
var shader21 = `#if SCENE_MRT_COUNT>0
...
var pbrBlockPrePassWGSL = { name: name21, shader: shader21 };

// node_modules/@babylonjs/core/ShadersWGSL/pbr.fragment.js
var name22 = "pbrPixelShader";
var shader22 = `#define PBR_FRAGMENT_SHADER
