...
// node_modules/@babylonjs/core/Shaders/gaussianSplattingVoxel.vertex.js
var name = "gaussianSplattingVoxelVertexShader";
...
var includes = [gaussianSplattingVertexDeclaration, sceneUboDeclaration, meshUboDeclaration, gaussianSplattingUboDeclaration, gaussianSplatting];
for (const inc of includes) {
  if (!ShaderStore.IncludesShadersStore[inc.name]) {
    ShaderStore.IncludesShadersStore[inc.name] = inc.shader;
  }
}
var gaussianSplattingVoxelVertexShader = { name, shader };
export {
  gaussianSplattingVoxelVertexShader
};
//# sourceMappingURL=gaussianSplattingVoxel.vertex-SQOSBIPS.js.map
