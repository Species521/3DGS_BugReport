...
// node_modules/@babylonjs/core/Sprites/spriteSceneComponent.pure.js
...
function RegisterSpriteSceneComponent() {
  if (_Registered) {
    return;
  }
  _Registered = true;
...
var SpriteRenderer = class _SpriteRenderer {
  /**
  ...
  async _initShaderSourceAsync() {
    ...
    if (engine.isWebGPU && !_SpriteRenderer.ForceGLSL) {
      ...
      await Promise.all([import("./sprites.vertex-CZV2DM4W.js"), import("./sprites.fragment-3BGTRQIM.js")]);
    } else {
      await Promise.all([import("./sprites.vertex-7ZYKAKNB.js"), import("./sprites.fragment-NXPN3VLE.js")]);
    }
...
var SpriteManager = class _SpriteManager {
  /**
   ...
   */
  constructor(name, imgUrl, capacity, cellSize, scene, epsilon = 0.01, samplingMode = Texture.TRILINEAR_SAMPLINGMODE, fromPacked = false, spriteJSON = null, options) {
    this.name = name;
...
//# sourceMappingURL=chunk-GKHG2BMR.js.map
