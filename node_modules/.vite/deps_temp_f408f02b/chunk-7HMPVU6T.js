import {
  GetTGAHeader
} from "./chunk-76TMIIX2.js";
import {
  RegisterAnimatable
} from "./chunk-ZSV6OVDO.js";
import {
  StorageBuffer
} from "./chunk-QOBXNHH7.js";
import {
  logDepthFragment
} from "./chunk-7SSPQKLN.js";
import {
  imageProcessingDeclaration
} from "./chunk-HL4IJEBC.js";
import {
  imageProcessingFunctions
} from "./chunk-BZJHPULU.js";
import {
  logDepthVertex
} from "./chunk-4XSO5KJF.js";
import {
  morphTargetsVertexGlobalDeclaration
} from "./chunk-MYDQQAGS.js";
import {
  morphTargetsVertexDeclaration
} from "./chunk-7AHW25SS.js";
import {
  logDepthDeclaration
} from "./chunk-UU5MMQVM.js";
import {
  morphTargetsVertexGlobal
} from "./chunk-DX4VBYOV.js";
import {
  morphTargetsVertex
} from "./chunk-TMVW5L4W.js";
import {
  helperFunctions
} from "./chunk-EP3E74CS.js";
import {
...
import {
  fogFragment
} from "./chunk-YOMB4IBA.js";
import {
  fogFragmentDeclaration
} from "./chunk-BTD52LQQ.js";
import {
  clipPlaneFragment
...
} from "./chunk-4A2VBUF2.js";
import {
  RawTexture
} from "./chunk-VTU6S7OW.js";
import {
  PassPostProcess,
  TextureTools
} from "./chunk-GIK43JLC.js";
import {
  PostProcess
} from "./chunk-R44AGSSU.js";
import {
  EffectWrapper
} from "./chunk-3TITET2K.js";
import {
  ShaderMaterial
...
import {
  ObjectRenderer,
  RenderTargetTexture
} from "./chunk-SXWIXRKO.js";
import {
  Texture
} from "./chunk-XYON5HHY.js";
import {
  useOpenGLOrientationForUV
} from "./chunk-6HF3G62K.js";
import {
  Engine
} from "./chunk-CBB4SEM4.js";
import {
  BaseTexture
} from "./chunk-Q7COFGXE.js";
import {
  Light
} from "./chunk-3GLUH32X.js";
import {
  Camera
} from "./chunk-KEUBNLTO.js";
import {
  Viewport
} from "./chunk-KCG2UG3W.js";
import {
  Node
} from "./chunk-63DO6QNO.js";
import {
  RegisterShadowGeneratorSceneComponent
} from "./chunk-REZR3ZSY.js";
import {
  AddParser
} from "./chunk-REFSEXSC.js";
import {
  StandardMaterial
} from "./chunk-T7XYUG44.js";
import {
  ImageProcessingConfigurationDefines,
  MaterialPluginBase,
  RegisterMaterialPlugin,
  UnregisterMaterialPlugin
} from "./chunk-MMCVNYZ4.js";
import {
  MaterialDefines
} from "./chunk-NDGPT7AD.js";
import {
  Material
} from "./chunk-3NQLHEYK.js";
import {
  DrawWrapper
} from "./chunk-CZU4PDGI.js";
import {
  EffectFallbacks
...
import {
  ThinEngine
} from "./chunk-XVE4XSBC.js";
import {
  LightConstants
} from "./chunk-WAGTS43G.js";
import {
  UniformBuffer
} from "./chunk-AZANHITH.js";
import {
  DeepCopier,
  Tools
} from "./chunk-3TQC532Q.js";
import {
  SerializationHelper
...
import {
  InternalTexture
} from "./chunk-G3IFHXQP.js";
import {
  ShaderStore
} from "./chunk-FX6MN5HL.js";
import {
  TimingTools
} from "./chunk-GVJRSP56.js";
import {
  WebRequest
} from "./chunk-IIMADQ7Q.js";
import {
  Logger
} from "./chunk-J4DZ2XK7.js";
import {
  EngineStore
} from "./chunk-JGRHS5JO.js";
import {
  Observable,
  _IsSideEffectImplemented,
  _WarnImport
...
function CreateAudioBusAsync(name10, options = {}, engine = null) {
  engine = _GetAudioEngine(engine);
  return engine.createBusAsync(name10, options);
}
function CreateMainAudioBusAsync(name10, options = {}, engine = null) {
  engine = _GetAudioEngine(engine);
  return engine.createMainBusAsync(name10, options);
}
function CreateMicrophoneSoundSourceAsync(name10, options = {}, engine = null) {
  engine = _GetAudioEngine(engine);
  return engine.createMicrophoneSoundSourceAsync(name10, options);
}
function CreateSoundAsync(name10, source, options = {}, engine = null) {
  engine = _GetAudioEngine(engine);
  return engine.createSoundAsync(name10, source, options);
}
...
function CreateSoundSourceAsync(name10, source, options = {}, engine = null) {
  engine = _GetAudioEngine(engine);
  return engine.createSoundSourceAsync(name10, source, options);
}
function CreateStreamingSoundAsync(name10, source, options = {}, engine = null) {
  engine = _GetAudioEngine(engine);
  return engine.createStreamingSoundAsync(name10, source, options);
}

// node_modules/@babylonjs/core/AudioV2/soundState.js
var SoundState;
(function(SoundState2) {
  SoundState2[SoundState2["Stopping"] = 0] = "Stopping";
  SoundState2[SoundState2["Stopped"] = 1] = "Stopped";
  SoundState2[SoundState2["Starting"] = 2] = "Starting";
  SoundState2[SoundState2["Started"] = 3] = "Started";
  SoundState2[SoundState2["FailedToStart"] = 4] = "FailedToStart";
  SoundState2[SoundState2["Paused"] = 5] = "Paused";
})(SoundState || (SoundState = {}));

// node_modules/@babylonjs/core/Meshes/Builders/planeBuilder.pure.js
...
function CreatePlane(name10, options = {}, scene = null) {
  const plane = new Mesh(name10, scene);
...
function RegisterPlaneBuilder() {
  if (_Registered) {
    return;
  }
  _Registered = true;
  VertexData.CreatePlane = CreatePlaneVertexData;
  Mesh.CreatePlane = (name10, size, scene, updatable, sideOrientation) => {
    const options = {
      size,
      width: size,
      height: size,
    ...
    return CreatePlane(name10, options, scene);
  };
}

// node_modules/@babylonjs/core/Materials/Textures/dynamicTexture.pure.js
var DynamicTexture = class _DynamicTexture extends Texture {
  /** @internal */
  constructor(name10, canvasOrSize, sceneOrOptions, generateMipMaps = false, samplingMode = 3, format = 5, invertY) {
...
// node_modules/@babylonjs/core/Engines/Extensions/engine.dynamicTexture.pure.js
...
// node_modules/@babylonjs/core/Engines/Extensions/engine.transformFeedback.pure.js
...
var ThinGlowBlurPostProcess = class _ThinGlowBlurPostProcess extends EffectWrapper {
  constructor(name10, engine = null, direction, kernel, options) {
    super({
      ...options,
      name: name10,
  ...
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      ...
      list.push(import("./glowBlurPostProcess.fragment-FFXGFBD2.js"));
    } else {
      list.push(import("./glowBlurPostProcess.fragment-RFC3CHQO.js"));
    }
...
var ThinEffectLayer = class _ThinEffectLayer {
   ...
   */
  constructor(name10, scene, forceGLSL = false, dontCheckIfReady = false, _additionalImportShadersAsync) {
  ...
  _internalIsSubMeshReady(subMesh, useInstances, emissiveTexture) {
    ...
    if (cachedDefines !== join) {
      ...
      drawWrapper.setEffect(this._engine.createEffect("glowMapGeneration", attribs, uniforms, ["diffuseSampler", "emissiveSampler", "opacitySampler", "boneSampler", "morphTargets", "bakedVertexAnimationTexture"], join, fallbacks, void 0, void 0, { maxSimultaneousMorphTargets: numMorphInfluencers }, this._shaderLanguage, this._shadersLoaded ? void 0 : async () => {
  ...
  async _importShadersAsync() {
    if (this._shaderLanguage === 1) {
      await Promise.all([import("./glowMapGeneration.vertex-M4O4UPRY.js"), import("./glowMapGeneration.fragment-S4KRVDDV.js")]);
    } else {
      await Promise.all([import("./glowMapGeneration.vertex-VS4FUHV5.js"), import("./glowMapGeneration.fragment-H5ZILRZ3.js")]);
    }
  ...
  _renderSubMesh(subMesh, enableAlphaMode = false) {
    ...
    if (this._useMeshMaterial(renderingMesh)) {
      ...
      engine.setState(material.backFaceCulling, material.zOffset, void 0, reverse, material.cullBackFaces, material.stencil, material.zOffsetUnits);
...
var ThinBlurPostProcess = class _ThinBlurPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(Promise.all([import("./kernelBlur.fragment-DQKHGP7J.js"), import("./kernelBlur.vertex-NSEHOUGM.js")]));
    } else {
      list.push(Promise.all([import("./kernelBlur.fragment-3X6PF74O.js"), import("./kernelBlur.vertex-UPN2CF7M.js")]));
    }
  }
  /**
...
var ThinGlowLayer = class _ThinGlowLayer extends ThinEffectLayer {
   ...
   * @param dontCheckIfReady Specifies if the layer should disable checking whether all the post processes are ready (default: false). To save performance, this should be set to true and you should call `isReady` manually before rendering to the layer.
   */
  constructor(name10, scene, options, dontCheckIfReady = false) {
    super(name10, scene, false, dontCheckIfReady);
    this._intensity = 1;
  ...
  async _importShadersAsync() {
    if (this._shaderLanguage === 1) {
      await Promise.all([
        import("./glowMapMerge.fragment-FFCI6RLW.js"),
        import("./glowMapMerge.vertex-G7FCOR3Y.js"),
        import("./glowBlurPostProcess.fragment-FFXGFBD2.js")
      ]);
    } else {
      await Promise.all([import("./glowMapMerge.fragment-YGLUL4YD.js"), import("./glowMapMerge.vertex-OK5NU4BP.js"), import("./glowBlurPostProcess.fragment-RFC3CHQO.js")]);
    }
...
var ThinExtractHighlightsPostProcess = class _ThinExtractHighlightsPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(import("./extractHighlights.fragment-4YXPYYGO.js"));
    } else {
      list.push(import("./extractHighlights.fragment-HJ55ZLH4.js"));
    }
  }
  /**
   ...
   * @param options Options to configure the effect
   */
  constructor(name10, engine = null, options) {
    super({
      ...options,
      name: name10,
      engine: engine || EngineStore.LastCreatedEngine,
...
var ThinBloomMergePostProcess = class _ThinBloomMergePostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(import("./bloomMerge.fragment-MP532ATV.js"));
    } else {
      list.push(import("./bloomMerge.fragment-H3T7J5LS.js"));
    }
  }
  constructor(name10, engine = null, options) {
    super({
...
var ThinBloomEffect = class {
   ...
   */
  constructor(name10, engine, scale, blockCompilation = false) {
    this.scale = scale;
    this._downscale = new ThinExtractHighlightsPostProcess(name10 + "_downscale", engine, { blockCompilation });
    this._blurX = new ThinBlurPostProcess(name10 + "_blurX", engine, new Vector2(1, 0), 10, { blockCompilation });
    this._blurY = new ThinBlurPostProcess(name10 + "_blurY", engine, new Vector2(0, 1), 10, { blockCompilation });
    this._merge = new ThinBloomMergePostProcess(name10 + "_merge", engine, { blockCompilation });
  }
  /**
...
var ThinChromaticAberrationPostProcess = class _ThinChromaticAberrationPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(import("./chromaticAberration.fragment-JTY5KFKD.js"));
    } else {
      list.push(import("./chromaticAberration.fragment-EAKQDOP5.js"));
    }
  }
  /**
...
var ThinCircleOfConfusionPostProcess = class _ThinCircleOfConfusionPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(import("./circleOfConfusion.fragment-45UV7W65.js"));
    } else {
      list.push(import("./circleOfConfusion.fragment-EYLMEKAD.js"));
    }
  }
  /**
...
var ThinDepthOfFieldBlurPostProcess = class extends ThinBlurPostProcess {
  constructor(name10, engine = null, direction, kernel, options) {
    super(name10, engine, direction, kernel, {
      ...options,
...
var ThinDepthOfFieldMergePostProcess = class _ThinDepthOfFieldMergePostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(import("./depthOfFieldMerge.fragment-3DMTV7YG.js"));
    } else {
      list.push(import("./depthOfFieldMerge.fragment-B34I5USE.js"));
    }
  }
  constructor(name10, engine = null, options) {
    super({
...
var ThinDepthOfFieldEffect = class {
   ...
   * @param blockCompilation If shaders should not be compiled when the effect is created (default: false)
   */
  constructor(name10, engine, blurLevel = 0, depthNotNormalized = false, blockCompilation = false) {
    this._depthOfFieldBlurX = [];
    this._depthOfFieldBlurY = [];
    this._circleOfConfusion = new ThinCircleOfConfusionPostProcess(name10, engine, { depthNotNormalized, blockCompilation });
    ...
    for (let i = 0; i < blurCount; i++) {
      this._depthOfFieldBlurY.push([new ThinDepthOfFieldBlurPostProcess(name10, engine, new Vector2(0, 1), adjustedKernelSize, { blockCompilation }), ratio]);
      ratio = 0.75 / Math.pow(2, i);
      this._depthOfFieldBlurX.push([new ThinDepthOfFieldBlurPostProcess(name10, engine, new Vector2(1, 0), adjustedKernelSize, { blockCompilation }), ratio]);
    }
    this._dofMerge = new ThinDepthOfFieldMergePostProcess(name10, engine, { blockCompilation });
  }
  /**
   * Checks if the effect is ready to be used
   * @returns if the effect is ready
...
var ThinFXAAPostProcess = class _ThinFXAAPostProcess extends EffectWrapper {
  ...
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(Promise.all([import("./fxaa.fragment-ZNIH4WZH.js"), import("./fxaa.vertex-ULIOEY37.js")]));
    } else {
      list.push(Promise.all([import("./fxaa.fragment-JQHK7HE5.js"), import("./fxaa.vertex-4CGZR3TU.js")]));
    }
  }
  /**
...
var ThinGrainPostProcess = class _ThinGrainPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(import("./grain.fragment-IOHXXZVE.js"));
    } else {
      list.push(import("./grain.fragment-LIKX6ZAJ.js"));
    }
  }
  /**
...
// node_modules/@babylonjs/core/PostProcesses/thinMotionBlurPostProcess.js
var ThinMotionBlurPostProcess = class _ThinMotionBlurPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(import("./motionBlur.fragment-YHOBBPQ2.js"));
    } else {
      list.push(import("./motionBlur.fragment-E6TUCXE4.js"));
    }
  }
  /**
   ...
   * @param options Options to configure the effect
   */
  constructor(name10, scene, options) {
    super({
      ...options,
      name: name10,
      ...
      useShaderStore: true,
      useAsPostProcess: true,
      fragmentShader: _ThinMotionBlurPostProcess.FragmentUrl,
      uniforms: _ThinMotionBlurPostProcess.Uniforms,
      samplers: _ThinMotionBlurPostProcess.Samplers,
      defines: _ThinMotionBlurPostProcess.Defines
    });
...
var ThinSharpenPostProcess = class _ThinSharpenPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(import("./sharpen.fragment-QIVBEIHG.js"));
    } else {
      list.push(import("./sharpen.fragment-KPXUXMZR.js"));
    }
  }
  /**
...
// node_modules/@babylonjs/core/Maths/halton2DSequence.js
...
// node_modules/@babylonjs/core/PostProcesses/blurPostProcess.pure.js
var BlurPostProcess = class _BlurPostProcess extends PostProcess {
   ...
   */
  constructor(name10, direction, kernel, options, camera = null, samplingMode = Texture.BILINEAR_SAMPLINGMODE, engine, reusable, textureType = 0, defines = "", blockCompilation = false, textureFormat = 5) {
    ...
    super(name10, ThinBlurPostProcess.FragmentUrl, {
      effectWrapper: typeof options === "number" || !options.effectWrapper ? new ThinBlurPostProcess(name10, engine, void 0, void 0, localOptions) : void 0,
      ...localOptions
    });
...
function RegisterBlurPostProcess() {
  if (_Registered4) {
    return;
  }
  _Registered4 = true;
...
var ShadowGenerator = class _ShadowGenerator {
  ...
  _createInstance() {
    ...
    if (!shadowGenerators) {
      shadowGenerators = this._light._shadowGenerators = /* @__PURE__ */ new Map();
    }
    ...
    RegisterShadowGeneratorSceneComponent(_ShadowGenerator);
  ...
  async _initShaderSourceAsync(forceGLSL = false) {
    ...
    if (engine.isWebGPU && !forceGLSL && !_ShadowGenerator.ForceGLSL) {
      this._shaderLanguage = 1;
      await Promise.all([
        import("./shadowMap.fragment-COGLMU7D.js"),
        import("./shadowMap.vertex-MVYTORIV.js"),
        import("./depthBoxBlur.fragment-R4ATT2OD.js"),
        import("./shadowMapFragmentSoftTransparentShadow-NXIJVYER.js")
      ]);
    } else {
      await Promise.all([
        import("./shadowMap.fragment-SGHNGRZH.js"),
        import("./shadowMap.vertex-DN477S62.js"),
        import("./depthBoxBlur.fragment-TFCN2ITT.js"),
        import("./shadowMapFragmentSoftTransparentShadow-NFDBXVVE.js")
      ]);
    }
    this._shadersLoaded = true;
  }
...
var ConeParticleEmitter = class _ConeParticleEmitter {
  ...
  parse(serializationObject) {
    ...
    this.heightRange = serializationObject.heightRange !== void 0 ? serializationObject.heightRange : 1;
...
function CreateMeshEmitter(mesh = null) {
  return new MeshParticleEmitter(mesh);
}

// node_modules/@babylonjs/core/Particles/baseParticleSystem.pure.js
...
var _Registered5 = false;
function RegisterBaseParticleSystem() {
  if (_Registered5) {
    return;
  }
  _Registered5 = true;
...
// node_modules/@babylonjs/core/Layers/effectLayerSceneComponent.pure.js
...
var _Registered6 = false;
function RegisterEffectLayerSceneComponent(effectLayerClass) {
  if (_Registered6) {
    return;
  }
  _Registered6 = true;
...
var EffectLayer = class _EffectLayer {
   ...
   */
  constructor(name10, scene, forceGLSL = false, thinEffectLayer) {
    ...
    if (!thinEffectLayer) {
      thinEffectLayer = new ThinEffectLayer(name10, scene, forceGLSL, false, this._importShadersAsync.bind(this));
    ...
    this.name = name10;
    this._scene = scene || EngineStore.LastCreatedScene;
    RegisterEffectLayerSceneComponent(_EffectLayer);
...
// node_modules/@babylonjs/core/Layers/glowLayer.pure.js
var GlowLayer = class _GlowLayer extends EffectLayer {
   ...
   */
  constructor(name10, scene, options) {
    super(name10, scene, false, new ThinGlowLayer(name10, scene, options));
    this._options = {
...
var _Registered7 = false;
function RegisterGlowLayer() {
  if (_Registered7) {
    return;
  }
  _Registered7 = true;
  Scene.prototype.getGlowLayerByName = function(name10) {
    for (let index = 0; index < this.effectLayers?.length; index++) {
      if (this.effectLayers[index].name === name10 && this.effectLayers[index].getEffectName() === GlowLayer.EffectName) {
...
var Layer = class _Layer {
   ...
   * @param forceGLSL Use the GLSL code generation for the shader (even on WebGPU). Default is false
   */
  constructor(name10, imgUrl, scene, isBackground, color, forceGLSL = false) {
    this.name = name10;
  ...
  isReady() {
    ...
    if (this._previousDefines !== defines) {
      ...
      this._drawWrapper.effect = engine.createEffect("layer", [VertexBuffer.PositionKind], ["textureMatrix", "color", "scale", "offset"], ["textureSampler"], defines, void 0, void 0, void 0, void 0, this._shaderLanguage, this._shadersLoaded ? void 0 : async () => {
        if (this._shaderLanguage === 1) {
          await Promise.all([import("./layer.vertex-STA5NDYD.js"), import("./layer.fragment-VGC33FZ2.js")]);
        } else {
          await Promise.all([import("./layer.vertex-E3WIZVTX.js"), import("./layer.fragment-EJN6COPD.js")]);
        }
        this._shadersLoaded = true;
      });
    }
...
// node_modules/@babylonjs/core/Lights/Clustered/clusteredLightingSceneComponent.pure.js
...
var _Registered8 = false;
function RegisterClusteredLightingSceneComponent(clusteredLightContainerClass) {
  if (_Registered8) {
    return;
  }
  _Registered8 = true;
...
var DefaultDepthSlices = 16;
var MobileClusteredLightBatchSize = 8;
var ClusteredLightContainer = class _ClusteredLightContainer extends Light {
   ...
   */
  constructor(name10, lights = [], scene) {
    super(name10, scene);
    this._lights = [];
    this._camera = null;
    this._sortedLights = [];
    ...
    this._proxyMaterial = new ShaderMaterial("ProxyMaterial", this._scene, proxyShader, {
      ...
      extraInitializationsAsync: async () => {
        if (engine.isWebGPU) {
          await Promise.all([import("./lightProxy.vertex-4DBSZJV6.js"), import("./lightProxy.fragment-NCXEA7CR.js")]);
        } else {
          await Promise.all([import("./lightProxy.vertex-ZHGQX5D4.js"), import("./lightProxy.fragment-P7YONSF2.js")]);
        }
      }
    });
    ...
    if (this._batchSize > 0) {
      RegisterClusteredLightingSceneComponent(_ClusteredLightContainer);
...
var _Registered9 = false;
function RegisterClusteredLightContainer() {
  if (_Registered9) {
    return;
  }
  _Registered9 = true;
  Node.AddNodeConstructor("Light_Type_5", (name10, scene) => {
    return () => new ClusteredLightContainer(name10, [], scene);
  });
  RegisterClass("BABYLON.ClusteredLightContainer", ClusteredLightContainer);
}

// node_modules/@babylonjs/core/Materials/Textures/colorGradingTexture.pure.js
var ColorGradingTexture = class _ColorGradingTexture extends BaseTexture {
  /**
  ...
  _load3dlTexture() {
    ...
    const callback = (text) => {
      ...
      for (let i = 0; i < lines.length; i++) {
        line = lines[i];
        if (!_ColorGradingTexture._NoneEmptyLineRegex.test(line)) {
          continue;
        }
        if (line.indexOf("#") === 0) {
          continue;
   ...
   */
  clone() {
    const newTexture = new _ColorGradingTexture(this.url, this.getScene() || this._getEngine());
    newTexture.level = this.level;
    return newTexture;
  }
  /**
...
var _Registered10 = false;
function ColorGradingTextureParse(parsedTexture, scene) {
  let texture = null;
...
function RegisterColorGradingTexture() {
  if (_Registered10) {
    return;
  }
  _Registered10 = true;
...
// node_modules/@babylonjs/core/PostProcesses/fxaaPostProcess.pure.js
var FxaaPostProcess = class _FxaaPostProcess extends PostProcess {
  ...
  constructor(name10, options, camera = null, samplingMode, engine, reusable, textureType = 0) {
    const localOptions = {
    ...
    super(name10, ThinFXAAPostProcess.FragmentUrl, {
      effectWrapper: typeof options === "number" || !options.effectWrapper ? new ThinFXAAPostProcess(name10, engine, localOptions) : void 0,
      ...localOptions
    });
...
var _Registered11 = false;
function RegisterFxaaPostProcess() {
  if (_Registered11) {
    return;
  }
  _Registered11 = true;
...
var ParticleInternalProperties = class {
  constructor() {
...
var Particle = class _Particle {
  ...
  updateCellIndex() {
    ...
    if (this.particleSystem.spriteRandomStartCell) {
      if (this._properties.randomCellOffset === void 0) {
...
function _ProcessColorGradients(particle, system) {
  ...
  GradientHelper.GetCurrentGradient(system._ratio, colorGradients, (currentGradient, nextGradient, scale) => {
    if (currentGradient !== particle._properties.currentColorGradient) {
      ...
      nextGradient.getColorToRef(particle._properties.currentColor2);
      particle._properties.currentColorGradient = currentGradient;
    }
...
function _ProcessAngularSpeedGradients(particle, system) {
  GradientHelper.GetCurrentGradient(system._ratio, system._angularSpeedGradients, (currentGradient, nextGradient, scale) => {
    if (currentGradient !== particle._properties.currentAngularSpeedGradient) {
      ...
      particle._properties.currentAngularSpeed2 = nextGradient.getFactor();
      particle._properties.currentAngularSpeedGradient = currentGradient;
    }
...
function _ProcessVelocityGradients(particle, system) {
  GradientHelper.GetCurrentGradient(system._ratio, system._velocityGradients, (currentGradient, nextGradient, scale) => {
    if (currentGradient !== particle._properties.currentVelocityGradient) {
      ...
      particle._properties.currentVelocity2 = nextGradient.getFactor();
      particle._properties.currentVelocityGradient = currentGradient;
    }
...
function _ProcessLimitVelocityGradients(particle, system) {
  GradientHelper.GetCurrentGradient(system._ratio, system._limitVelocityGradients, (currentGradient, nextGradient, scale) => {
    if (currentGradient !== particle._properties.currentLimitVelocityGradient) {
      ...
      particle._properties.currentLimitVelocity2 = nextGradient.getFactor();
      particle._properties.currentLimitVelocityGradient = currentGradient;
    }
...
function _ProcessDragGradients(particle, system) {
  GradientHelper.GetCurrentGradient(system._ratio, system._dragGradients, (currentGradient, nextGradient, scale) => {
    if (currentGradient !== particle._properties.currentDragGradient) {
      ...
      particle._properties.currentDrag2 = nextGradient.getFactor();
      particle._properties.currentDragGradient = currentGradient;
    }
    const drag = Lerp(particle._properties.currentDrag1, particle._properties.currentDrag2, scale);
    particle._properties.scaledDirection.scaleInPlace(1 - drag);
  });
}
...
function _ProcessSizeGradients(particle, system) {
  GradientHelper.GetCurrentGradient(system._ratio, system._sizeGradients, (currentGradient, nextGradient, scale) => {
    if (currentGradient !== particle._properties.currentSizeGradient) {
      ...
      particle._properties.currentSize2 = nextGradient.getFactor();
      particle._properties.currentSizeGradient = currentGradient;
    }
...
// node_modules/@babylonjs/core/Particles/thinParticleSystem.pure.js
var ThinParticleSystem = class _ThinParticleSystem extends BaseParticleSystem {
   ...
   */
  constructor(name10, capacity, sceneOrEngine, customEffect = null, isAnimationSheetEnabled = false, epsilon = 0.01, noUpdateQueue = false) {
    RegisterAnimatable();
    super(name10);
   ...
   */
  clone(name10, newEmitter, _cloneTexture = false) {
    throw new Error("Method not implemented.");
  }
  ...
  async _initShaderSourceAsync() {
    ...
    if (engine.isWebGPU && !_ThinParticleSystem.ForceGLSL) {
      this._shaderLanguage = 1;
      await Promise.all([import("./particles.vertex-O2OTGDXZ.js"), import("./particles.fragment-N3BOND5D.js")]);
    } else {
      await Promise.all([import("./particles.vertex-3SF2IQGW.js"), import("./particles.fragment-WKYWEIT2.js")]);
    }
    this._shadersLoaded = true;
  }
  /**
...
// node_modules/@babylonjs/core/Particles/particleSystem.pure.js
var ParticleSystem = class _ParticleSystem extends ThinParticleSystem {
  ...
  static Parse(parsedParticleSystem, sceneOrEngine, rootUrl, doNotStart = false, capacity) {
    const name10 = parsedParticleSystem.name;
    let custom = null;
    let program = null;
    let engine;
    let scene;
    ...
    const particleSystem = new _ParticleSystem(name10, capacity || parsedParticleSystem.capacity, sceneOrEngine, custom, parsedParticleSystem.isAnimationSheetEnabled);
   ...
   */
  clone(name10, newEmitter, cloneTexture = false) {
...
// node_modules/@babylonjs/core/Offline/database.pure.js
var Database = class _Database {
  ...
  constructor(urlToScene, callbackManifestChecked, disableManifestCheck = false) {
    ...
    this._currentSceneUrl = _Database._ReturnFullUrlLocation(urlToScene);
    this._db = null;
    ...
    if (!_Database.IDBStorageEnabled) {
  ...
  _checkManifestFile(callbackManifestChecked) {
    ...
    xhr.addEventListener("load", () => {
      if (xhr.status === 200 || _Database._ValidateXHRData(xhr, 1)) {
        try {
          const manifestFile = JSON.parse(xhr.response);
          this._enableSceneOffline = manifestFile.enableSceneOffline;
          this._enableTexturesOffline = manifestFile.enableTexturesOffline && _Database._IsUaSupportingBlobStorage;
   ...
   */
  loadImage(url, image) {
    const completeURL = _Database._ReturnFullUrlLocation(url);
  ...
  _saveImageIntoDB(url, image) {
    ...
    if (this._isSupported) {
      ...
      if (_Database._IsUaSupportingBlobStorage) {
        const xhr = new WebRequest();
        xhr.open("GET", url);
        ...
        xhr.addEventListener("load", () => {
          if (xhr.status === 200 && this._db) {
            ...
            try {
              ...
              if (ex.code === 25) {
                _Database._IsUaSupportingBlobStorage = false;
                this._enableTexturesOffline = false;
              }
              image.src = url;
            }
  ...
  _saveFile(url, callback, progressCallback, useArrayBuffer, errorCallback) {
    if (this._isSupported) {
      ...
      xhr.addEventListener("load", () => {
        if (xhr.status === 200 || xhr.status < 400 && _Database._ValidateXHRData(xhr, !useArrayBuffer ? 1 : 6)) {
...
// node_modules/@babylonjs/core/Particles/gpuParticleSystem.pure.js
var GPUParticleSystem = class _GPUParticleSystem extends BaseParticleSystem {
   ...
   * @param isAnimationSheetEnabled Must be true if using a spritesheet to animate the particles texture
   */
  constructor(name10, options, sceneOrEngine, customEffect = null, isAnimationSheetEnabled = false) {
    RegisterAnimatable();
    super(name10);
    this.layerMask = 268435455;
    this._accumulatedCount = 0;
    ...
    this._currentStartSize1 = 0;
    this._currentStartSize2 = 0;
    this._startSizeGradientFactor = 1;
    this._lifeTimeGradientMin = 1;
    this._lifeTimeGradientMax = 1;
    this.doNotSerialize = false;
    this.onDisposeObservable = new Observable();
    this.onStoppedObservable = new Observable();
    this.onStartedObservable = new Observable();
   ...
   */
  fillUniformsAttributesAndSamplerNames(uniforms, attributes, samplers) {
    attributes.push(..._GPUParticleSystem._GetAttributeNamesOrOptions(!!this._colorGradientsTexture, this._isAnimationSheetEnabled, this._isBillboardBased, this._isBillboardBased && (this.billboardMode === ParticleSystem.BILLBOARDMODE_STRETCHED || this.billboardMode === ParticleSystem.BILLBOARDMODE_STRETCHED_LOCAL), this.billboardMode === ParticleSystem.BILLBOARDMODE_STRETCHED_LOCAL, this._hasColorGradientColor2));
  ...
  _update(emitterWM) {
    ...
    if (this._attractors.length > 0) {
      ...
      for (let i = 0; i < this._attractors.length; i++) {
        ...
        const name10 = "attractorPositionAndStrength[" + i + "]";
        if (invWorld) {
          const localPos = TmpVectors.Vector3[0];
          Vector3.TransformCoordinatesToRef(attractor.position, invWorld, localPos);
          this._updateBuffer.setFloat4(name10, localPos.x, localPos.y, localPos.z, attractor.strength);
        } else {
          this._updateBuffer.setFloat4(name10, attractor.position.x, attractor.position.y, attractor.position.z, attractor.strength);
        }
      }
    }
    if (this._startSizeGradients && this._startSizeGradients.length > 0) {
  ...
  static fromParticleSystem(source, sceneOrEngine, options) {
    ...
    if (options?.randomTextureSize !== void 0) {
      gpuOptions.randomTextureSize = options.randomTextureSize;
    }
    gpuOptions.emitRateControl = options?.emitRateControl ?? true;
    if (options?.maxAttractors !== void 0) {
      gpuOptions.maxAttractors = options.maxAttractors;
    }
    const gpu = new _GPUParticleSystem(source.name + " (GPU)", gpuOptions, sceneOrEngine, null, source.isAnimationSheetEnabled);
    gpu.id = source.id;
  ...
  static Parse(parsedParticleSystem, sceneOrEngine, rootUrl, doNotStart = false, capacity) {
    ...
    const particleSystem = new _GPUParticleSystem(name10, {
...
var clipPlaneFragmentDeclaration2 = { name, shader };
...
var includes = [clipPlaneFragmentDeclaration2, imageProcessingDeclaration, logDepthDeclaration, helperFunctions, imageProcessingFunctions, fogFragmentDeclaration, clipPlaneFragment, logDepthFragment, fogFragment];
...
var clipPlaneVertexDeclaration2 = { name: name3, shader: shader3 };
...
var includes2 = [clipPlaneVertexDeclaration2, fogVertexDeclaration, logDepthDeclaration, clipPlaneVertex, fogVertex, logDepthVertex];
for (const inc of includes2) {
  if (!ShaderStore.IncludesShadersStore[inc.name]) {
    ShaderStore.IncludesShadersStore[inc.name] = inc.shader;
  }
}
...
var ParticleSystemSet = class _ParticleSystemSet {
  constructor() {
...
var NodeParticleConnectionPoint = class {
   ...
   */
  constructor(name10, ownerBlock, direction) {
...
var NodeParticleBlock = class {
   ...
   */
  getInputByName(name10) {
    const filter = this._inputs.filter((e) => e.name === name10);
    if (filter.length) {
      return filter[0];
    }
    return null;
   ...
   */
  registerInput(name10, type, isOptional = false, value, valueMin, valueMax) {
   ...
   * @returns the current block
   */
  registerOutput(name10, type, point) {
...
// node_modules/@babylonjs/core/Particles/Node/Blocks/systemBlock.pure.js
var SystemBlock = class _SystemBlock extends NodeParticleBlock {
  /**
  ...
  _deserialize(serializationObject) {
    ...
    if (serializationObject.customShader !== void 0) {
...
__decorate([
  editableInPropertyPage("Rendering group id", 2, "ADVANCED", { embedded: true, notifiers: { rebuild: true }, min: 0 })
], SystemBlock.prototype, "renderingGroupId", void 0);
var _Registered14 = false;
function RegisterSystemBlock() {
  if (_Registered14) {
    return;
  }
  _Registered14 = true;
...
// node_modules/@babylonjs/core/Particles/Node/Blocks/particleInputBlock.pure.js
var ParticleInputBlock = class extends NodeParticleBlock {
  /**
   * Gets or sets the connection point type (default is float)
   */
  get type() {
   ...
   */
  constructor(name10, type = NodeParticleBlockConnectionPointTypes.AutoDetect) {
    super(name10);
...
var _Registered15 = false;
function RegisterParticleInputBlock() {
  if (_Registered15) {
    return;
  }
  _Registered15 = true;
...
// node_modules/@babylonjs/core/Particles/Node/Blocks/particleSourceTextureBlock.pure.js
var ParticleTextureSourceBlock = class extends NodeParticleBlock {
  /**
  ...
  async extractTextureContentAsync() {
    ...
    return await new Promise((resolve, reject) => {
      const extractProceduralTextureContentAsync = async (proceduralTexture) => {
        ...
        const size2 = proceduralTexture.getSize();
        return {
          width: size2.width,
          height: size2.height,
      ...
      if (!texture.isReady()) {
        ...
        internalErrorObserver = texture.getInternalTexture()?.onErrorObservable.addOnce(() => {
          settle(null);
        }) ?? null;
      ...
      if (texture.getContent) {
        extractProceduralTextureContentAsync(texture)?.then((data) => {
    ...
    if (this._sourceTexture) {
      ...
      if (sourceEngine && sourceEngine !== targetEngine) {
        ...
        if (url) {
          ...
          this.textureOutput._storedValue = tex2;
          return;
        }
...
var _Registered16 = false;
function RegisterParticleSourceTextureBlock() {
  if (_Registered16) {
    return;
  }
  _Registered16 = true;
...
// node_modules/@babylonjs/core/Particles/Node/Blocks/Update/updatePositionBlock.pure.js
...
function RegisterUpdatePositionBlock() {
  if (_Registered17) {
    return;
  }
  _Registered17 = true;
...
// node_modules/@babylonjs/core/Particles/Node/Blocks/particleMathBlock.pure.js
...
var ParticleMathBlock = class extends NodeParticleBlock {
  /**
...
var _Registered18 = false;
function RegisterParticleMathBlock() {
  if (_Registered18) {
    return;
  }
  _Registered18 = true;
...
// node_modules/@babylonjs/core/Particles/Node/Blocks/Emitters/boxShapeBlock.pure.js
var BoxShapeBlock = class extends NodeParticleBlock {
  /**
...
var _Registered19 = false;
function RegisterBoxShapeBlock() {
  if (_Registered19) {
    return;
  }
  _Registered19 = true;
...
// node_modules/@babylonjs/core/Particles/Node/Blocks/Emitters/createParticleBlock.pure.js
var ColorDiff = new Color4();
var CreateParticleBlock = class extends NodeParticleBlock {
  /**
...
var _Registered20 = false;
function RegisterCreateParticleBlock() {
  if (_Registered20) {
    return;
  }
  _Registered20 = true;
...
var NodeParticleSystemSet = class _NodeParticleSystemSet {
  /**
   ...
   */
  getBlockByName(name10) {
    let result = null;
    for (const block of this.attachedBlocks) {
      if (block.name === name10) {
        if (!result) {
          result = block;
        } else {
          Tools.Warn("More than one block was found with the name `" + name10 + "`");
          return result;
        }
      }
    }
  ...
  clone(name10) {
    const serializationObject = this.serialize();
    const clone = SerializationHelper.Clone(() => new _NodeParticleSystemSet(name10), this);
    clone.name = name10;
   ...
   */
  static CreateDefault(name10) {
    const nodeParticleSet = new _NodeParticleSystemSet(name10);
   ...
   */
  // eslint-disable-next-line @typescript-eslint/promise-function-async, no-restricted-syntax
  static ParseFromFileAsync(name10, url, nodeParticleSet) {
      ...
      request.addEventListener("readystatechange", () => {
        if (request.readyState == 4) {
          if (request.status == 200) {
            ...
            if (!nodeParticleSet) {
              nodeParticleSet = SerializationHelper.Parse(() => new _NodeParticleSystemSet(name10), serializationObject, null);
            }
...
var PostProcessRenderEffect = class {
   ...
   */
  constructor(engine, name10, getPostProcesses, singleInstance = true) {
    this._name = name10;
...
// node_modules/@babylonjs/core/PostProcesses/extractHighlightsPostProcess.pure.js
var ExtractHighlightsPostProcess = class extends PostProcess {
  ...
  constructor(name10, options, camera = null, samplingMode, engine, reusable, textureType = 0, blockCompilation = false) {
    const localOptions = {
    ...
    super(name10, ThinExtractHighlightsPostProcess.FragmentUrl, {
      effectWrapper: typeof options === "number" || !options.effectWrapper ? new ThinExtractHighlightsPostProcess(name10, engine, localOptions) : void 0,
      ...localOptions
    });
...
var _Registered21 = false;
function RegisterExtractHighlightsPostProcess() {
  if (_Registered21) {
    return;
  }
  _Registered21 = true;
...
// node_modules/@babylonjs/core/PostProcesses/bloomMergePostProcess.pure.js
var BloomMergePostProcess = class extends PostProcess {
   ...
   * @param blockCompilation If compilation of the shader should not be done in the constructor. The updateEffect method can be used to compile the shader at a later time. (default: false)
   */
  constructor(name10, originalFromInput, blurred, weight, options, camera = null, samplingMode, engine, reusable, textureType = 0, blockCompilation = false) {
    const blockCompilationFinal = typeof options === "number" ? blockCompilation : !!options.blockCompilation;
    const localOptions = {
    ...
    super(name10, ThinBloomMergePostProcess.FragmentUrl, {
      effectWrapper: typeof options === "number" || !options.effectWrapper ? new ThinBloomMergePostProcess(name10, engine, localOptions) : void 0,
      ...localOptions
    });
    this.weight = weight;
...
var _Registered22 = false;
function RegisterBloomMergePostProcess() {
  if (_Registered22) {
    return;
  }
  _Registered22 = true;
...
// node_modules/@babylonjs/core/PostProcesses/chromaticAberrationPostProcess.pure.js
var ChromaticAberrationPostProcess = class _ChromaticAberrationPostProcess extends PostProcess {
   ...
   * @param blockCompilation If compilation of the shader should not be done in the constructor. The updateEffect method can be used to compile the shader at a later time. (default: false)
   */
  constructor(name10, screenWidth, screenHeight, options, camera, samplingMode, engine, reusable, textureType = 0, blockCompilation = false) {
    const localOptions = {
    ...
    super(name10, ThinChromaticAberrationPostProcess.FragmentUrl, {
      effectWrapper: typeof options === "number" || !options.effectWrapper ? new ThinChromaticAberrationPostProcess(name10, engine, localOptions) : void 0,
      ...localOptions
    });
...
var _Registered23 = false;
function RegisterChromaticAberrationPostProcess() {
  if (_Registered23) {
    return;
  }
  _Registered23 = true;
...
// node_modules/@babylonjs/core/PostProcesses/circleOfConfusionPostProcess.pure.js
var CircleOfConfusionPostProcess = class extends PostProcess {
   ...
   * @param blockCompilation If compilation of the shader should not be done in the constructor. The updateEffect method can be used to compile the shader at a later time. (default: false)
   */
  constructor(name10, depthTexture, options, camera, samplingMode, engine, reusable, textureType = 0, blockCompilation = false) {
    const localOptions = {
    ...
    super(name10, ThinCircleOfConfusionPostProcess.FragmentUrl, {
      effectWrapper: typeof options === "number" || !options.effectWrapper ? new ThinCircleOfConfusionPostProcess(name10, engine, localOptions) : void 0,
      ...localOptions
    });
...
var _Registered24 = false;
function RegisterCircleOfConfusionPostProcess() {
  if (_Registered24) {
    return;
  }
  _Registered24 = true;
...
// node_modules/@babylonjs/core/PostProcesses/depthOfFieldBlurPostProcess.pure.js
var DepthOfFieldBlurPostProcess = class extends BlurPostProcess {
   ...
   * @param textureFormat Format of textures used when performing the post process. (default: TEXTUREFORMAT_RGBA)
   */
  constructor(name10, _scene, direction, kernel, options, camera, circleOfConfusion, imageToBlur = null, samplingMode = Texture.BILINEAR_SAMPLINGMODE, engine, reusable, textureType = 0, blockCompilation = false, textureFormat = 5) {
    const localOptions = {
      size: typeof options === "number" ? options : void 0,
      camera,
      // eslint-disable-next-line @typescript-eslint/no-unused-vars
...
`,
    ...
    super(name10, direction, kernel, {
      effectWrapper: typeof options === "number" || !options.effectWrapper ? new ThinDepthOfFieldBlurPostProcess(name10, engine, direction, kernel, localOptions) : void 0,
      ...localOptions
    });
...
var _Registered25 = false;
function RegisterDepthOfFieldBlurPostProcess() {
  if (_Registered25) {
    return;
  }
  _Registered25 = true;
...
var DepthOfFieldMergePostProcess = class extends PostProcess {
   ...
   * @param blockCompilation If compilation of the shader should not be done in the constructor. The updateEffect method can be used to compile the shader at a later time. (default: false)
   */
  constructor(name10, originalFromInput, circleOfConfusion, _blurSteps, options, camera, samplingMode, engine, reusable, textureType = 0, blockCompilation = false) {
    const blockCompilationFinal = typeof options === "number" ? blockCompilation : !!options.blockCompilation;
    const localOptions = {
    ...
    super(name10, ThinDepthOfFieldMergePostProcess.FragmentUrl, {
      effectWrapper: typeof options === "number" || !options.effectWrapper ? new ThinDepthOfFieldMergePostProcess(name10, engine, localOptions) : void 0,
      ...localOptions
    });
...
// node_modules/@babylonjs/core/PostProcesses/grainPostProcess.pure.js
var GrainPostProcess = class _GrainPostProcess extends PostProcess {
   ...
   * @param blockCompilation If compilation of the shader should not be done in the constructor. The updateEffect method can be used to compile the shader at a later time. (default: false)
   */
  constructor(name10, options, camera, samplingMode, engine, reusable, textureType = 0, blockCompilation = false) {
    const localOptions = {
    ...
    super(name10, ThinGrainPostProcess.FragmentUrl, {
      effectWrapper: typeof options === "number" || !options.effectWrapper ? new ThinGrainPostProcess(name10, engine, localOptions) : void 0,
      ...localOptions
    });
  }
  /**
...
var _Registered26 = false;
function RegisterGrainPostProcess() {
  if (_Registered26) {
    return;
  }
  _Registered26 = true;
...
// node_modules/@babylonjs/core/PostProcesses/motionBlurPostProcess.pure.js
var MotionBlurPostProcess = class _MotionBlurPostProcess extends PostProcess {
  /**
   ...
   */
  constructor(name10, scene, options, camera, samplingMode, engine, reusable, textureType = 0, blockCompilation = false, forceGeometryBuffer = false) {
    const localOptions = {
    ...
    super(name10, ThinMotionBlurPostProcess.FragmentUrl, {
      effectWrapper: typeof options === "number" || !options.effectWrapper ? new ThinMotionBlurPostProcess(name10, scene, localOptions) : void 0,
      ...localOptions
    });
  ...
  static _Parse(parsedPostProcess, targetCamera, scene, rootUrl) {
    return SerializationHelper.Parse(() => {
      return new _MotionBlurPostProcess(parsedPostProcess.name, scene, parsedPostProcess.options, targetCamera, parsedPostProcess.renderTargetSamplingMode, scene.getEngine(), parsedPostProcess.reusable, parsedPostProcess.textureType, false);
    }, parsedPostProcess, scene, rootUrl);
  }
};
__decorate([
...
var _Registered27 = false;
function RegisterMotionBlurPostProcess() {
  if (_Registered27) {
    return;
  }
  _Registered27 = true;
...
// node_modules/@babylonjs/core/PostProcesses/sharpenPostProcess.pure.js
var SharpenPostProcess = class _SharpenPostProcess extends PostProcess {
  ...
  constructor(name10, options, camera, samplingMode, engine, reusable, textureType = 0, blockCompilation = false) {
    ...
    super(name10, ThinSharpenPostProcess.FragmentUrl, {
      effectWrapper: typeof options === "number" || !options.effectWrapper ? new ThinSharpenPostProcess(name10, engine, localOptions) : void 0,
      ...localOptions
    });
...
var _Registered28 = false;
function RegisterSharpenPostProcess() {
  if (_Registered28) {
    return;
  }
  _Registered28 = true;
...
// node_modules/@babylonjs/core/PostProcesses/RenderPipeline/postProcessRenderPipelineManagerSceneComponent.pure.js
...
// node_modules/@babylonjs/core/PostProcesses/RenderPipeline/Pipelines/defaultRenderingPipeline.pure.js
var DefaultRenderingPipeline = class extends PostProcessRenderPipeline {
   ...
   */
  constructor(name10 = "", hdr = true, scene = EngineStore.LastCreatedScene, cameras, automaticBuild = true) {
    RegisterDepthRendererSceneComponent(DepthRenderer);
    super(scene.getEngine(), name10);
...
var ThinSSAO2PostProcess = class _ThinSSAO2PostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(import("./ssao2.fragment-N3EPKSLQ.js"));
    } else {
      list.push(import("./ssao2.fragment-YZQCJF5V.js"));
    }
  }
  get textureWidth() {
...
var ThinSSAO2BlurPostProcess = class _ThinSSAO2BlurPostProcess extends EffectWrapper {
  ...
  constructor(name10, engine = null, isHorizontal, options) {
    super({
      ...options,
      name: name10,
      engine: engine || EngineStore.LastCreatedEngine,
...
var ThinSSAO2CombinePostProcess = class _ThinSSAO2CombinePostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(import("./ssaoCombine.fragment-QNNKDU3B.js"));
    } else {
      list.push(import("./ssaoCombine.fragment-DSUK6VCP.js"));
    }
  }
  constructor(name10, engine = null, options) {
    super({
...
// node_modules/@babylonjs/core/PostProcesses/RenderPipeline/Pipelines/ssao2RenderingPipeline.pure.js
var SSAO2RenderingPipeline = class extends PostProcessRenderPipeline {
   ...
   */
  constructor(name10, scene, ratio, cameras, forceGeometryBuffer = false, textureType = 0) {
    ...
    this._thinSSAORenderingPipeline = new ThinSSAO2RenderingPipeline(name10, scene);
    this._scene = scene;
    this._ratio = ratio;
    ...
    scene.postProcessRenderPipelineManager.addPipeline(this);
    if (cameras) {
      scene.postProcessRenderPipelineManager.attachCamerasToRenderPipeline(name10, cameras);
    }
  }
  // Public Methods
  /**
  ...
  _createBlurFilter(name10, ratio, textureType, horizontal) {
    const blurFilter = new PostProcess(name10, ThinSSAO2BlurPostProcess.FragmentUrl, {
      size: ratio,
      samplingMode: 2,
      engine: this._scene.getEngine(),
...
var TrsWebGPU = Matrix.Compose(new Vector3(0.5, 0.5, 1), Quaternion.Identity(), new Vector3(0.5, 0.5, 0));
var ThinSSRPostProcess = class _ThinSSRPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(import("./screenSpaceReflection2.fragment-QC37UHAB.js"));
    } else {
      list.push(import("./screenSpaceReflection2.fragment-GQ4FMLRM.js"));
    }
  }
...
var ThinSSRBlurPostProcess = class _ThinSSRBlurPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(import("./screenSpaceReflection2Blur.fragment-P6VN54HL.js"));
    } else {
      list.push(import("./screenSpaceReflection2Blur.fragment-MMW5NP27.js"));
    }
  }
  constructor(name10, engine = null, direction, blurStrength, options) {
    super({
      ...options,
      name: name10,
      engine: engine || EngineStore.LastCreatedEngine,
...
var ThinSSRBlurCombinerPostProcess = class _ThinSSRBlurCombinerPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(import("./screenSpaceReflection2BlurCombiner.fragment-5LA4AAGW.js"));
    } else {
      list.push(import("./screenSpaceReflection2BlurCombiner.fragment-ZWIGF5H6.js"));
    }
  }
  constructor(name10, engine = null, options) {
    super({
...
// node_modules/@babylonjs/core/PostProcesses/RenderPipeline/Pipelines/ssrRenderingPipeline.pure.js
var SSRRenderingPipeline = class extends PostProcessRenderPipeline {
  /**
   * MSAA sample count, setting this to 4 will provide 4x anti aliasing. (default: 1)
   */
  set samples(sampleCount) {
   ...
   */
  constructor(name10, scene, cameras, forceGeometryBuffer = false, textureType = 0, useScreenspaceDepth = false) {
    RegisterPrePassRendererSceneComponent(PrePassRenderer);
    RegisterGeometryBufferRendererSceneComponent(GeometryBufferRenderer);
    super(scene.getEngine(), name10);
    ...
    this._isDirty = false;
    this._camerasToBeAttached = [];
    this._thinSSRRenderingPipeline = new ThinSSRRenderingPipeline(name10, scene);
...
var _Registered32 = false;
function SSRRenderingPipelineParse(source, scene, rootUrl) {
  return SerializationHelper.Parse(() => new SSRRenderingPipeline(source._name, scene, source._ratio), source, scene, rootUrl);
}
function RegisterSsrRenderingPipeline() {
  if (_Registered32) {
    return;
  }
  _Registered32 = true;
...
// node_modules/@babylonjs/core/PostProcesses/RenderPipeline/Pipelines/taaMaterialManager.pure.js
...
var TAAJitterMaterialPlugin = class _TAAJitterMaterialPlugin extends MaterialPluginBase {
  get manager() {
  ...
  constructor(material) {
    super(material, _TAAJitterMaterialPlugin.Name, 300, new TAAJitterMaterialDefines());
...
var _Registered33 = false;
function RegisterTaaMaterialManager() {
  if (_Registered33) {
    return;
  }
  _Registered33 = true;
...
// node_modules/@babylonjs/core/PostProcesses/RenderPipeline/Pipelines/taaMaterialManager.js
RegisterTaaMaterialManager();

// node_modules/@babylonjs/core/PostProcesses/thinTAAPostProcess.js
var ThinTAAPostProcess = class _ThinTAAPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(import("./taa.fragment-6WJK3VPJ.js"));
    } else {
      list.push(import("./taa.fragment-TUIGLGQZ.js"));
    }
  }
  /**
  ...
  constructor(name10, scene, options) {
    super({
      ...
      useShaderStore: true,
      useAsPostProcess: true,
      fragmentShader: _ThinTAAPostProcess.FragmentUrl,
      uniforms: _ThinTAAPostProcess.Uniforms,
      samplers: _ThinTAAPostProcess.Samplers
    });
    this._samples = 8;
    this.factor = 0.05;
...
// node_modules/@babylonjs/core/PostProcesses/RenderPipeline/Pipelines/taaRenderingPipeline.pure.js
var TAAEffectConfiguration = class {
  constructor() {
    this.name = "taa";
    this.enabled = true;
...
var TAARenderingPipeline = class extends PostProcessRenderPipeline {
  /**
   ...
   */
  constructor(name10, scene, cameras, textureType = 0) {
    RegisterPrePassRendererSceneComponent(PrePassRenderer);
    const engine = scene.getEngine();
    super(engine, name10);
...
var _Registered34 = false;
function TAARenderingPipelineParse(source, scene, rootUrl) {
  return SerializationHelper.Parse(() => new TAARenderingPipeline(source._name, scene, source._ratio), source, scene, rootUrl);
}
function RegisterTaaRenderingPipeline() {
  if (_Registered34) {
    return;
  }
  _Registered34 = true;
...
// node_modules/@babylonjs/core/PostProcesses/volumetricLightScatteringPostProcess.pure.js
var VolumetricLightScatteringPostProcess = class _VolumetricLightScatteringPostProcess extends PostProcess {
   ...
   */
  constructor(name10, ratio, camera, mesh, samples = 100, samplingMode = Texture.BILINEAR_SAMPLINGMODE, engine, reusable, scene) {
    super(name10, "volumetricLightScattering", ["decay", "exposure", "weight", "meshPositionOnScreen", "density"], ["lightScatteringSampler"], ratio.postProcessRatio || ratio, camera, samplingMode, engine, reusable, "#define NUM_SAMPLES " + samples);
   ...
   */
  static CreateDefaultMesh(name10, scene) {
    const mesh = CreatePlane(name10, { size: 1 }, scene);
    mesh.billboardMode = AbstractMesh.BILLBOARDMODE_ALL;
    const material = new StandardMaterial(name10 + "Material", scene);
...
var _Registered35 = false;
function RegisterVolumetricLightScatteringPostProcess() {
  if (_Registered35) {
    return;
  }
  _Registered35 = true;
...
// node_modules/@babylonjs/core/Sprites/spriteMap.pure.js
var SpriteMapFrameRotationDirection;
(function(SpriteMapFrameRotationDirection2) {
  SpriteMapFrameRotationDirection2[SpriteMapFrameRotationDirection2["CCW"] = 0] = "CCW";
  SpriteMapFrameRotationDirection2[SpriteMapFrameRotationDirection2["CW"] = 1] = "CW";
...
var SpriteMap = class {
   ...
   */
  constructor(name10, atlasJSON, spriteSheet, options, scene) {
    this.name = name10;
    this.sprites = [];
    ...
    this._output = CreatePlane(name10 + ":output", { size: 1, updatable: true }, scene);
   ...
   */
  getTileIdxByName(name10) {
    const idx = this.atlasJSON.frames.findIndex((f) => f.filename === name10);
    return idx;
  }
  /**
...
// node_modules/@babylonjs/core/PostProcesses/RenderPipeline/Pipelines/taaRenderingPipeline.js
RegisterTaaRenderingPipeline();

// node_modules/@babylonjs/core/Shaders/volumetricLightScattering.fragment.js
var name5 = "volumetricLightScatteringPixelShader";
var shader5 = `uniform sampler2D textureSampler;uniform sampler2D lightScatteringSampler;uniform float decay;uniform float exposure;uniform float weight;uniform float density;uniform vec2 meshPositionOnScreen;varying vec2 vUV;
...
var name6 = "volumetricLightScatteringPassVertexShader";
var shader6 = `attribute vec3 position;
...
var includes3 = [bonesDeclaration, bakedVertexAnimationDeclaration, morphTargetsVertexGlobalDeclaration, morphTargetsVertexDeclaration, instancesDeclaration, morphTargetsVertexGlobal, morphTargetsVertex, instancesVertex, bonesVertex, bakedVertexAnimation];
for (const inc of includes3) {
  if (!ShaderStore.IncludesShadersStore[inc.name]) {
    ShaderStore.IncludesShadersStore[inc.name] = inc.shader;
  }
}
...
var name7 = "volumetricLightScatteringPassPixelShader";
var shader7 = `#if defined(ALPHATEST) || defined(NEED_UV)
varying vec2 vUV;
#endif
...
var name8 = "spriteMapPixelShader";
var shader8 = `#ifdef LOGARITHMICDEPTH
#extension GL_EXT_frag_depth : enable
#endif
...
var includes4 = [fogFragmentDeclaration, logDepthDeclaration, logDepthFragment, fogFragment];
for (const inc of includes4) {
  if (!ShaderStore.IncludesShadersStore[inc.name]) {
    ShaderStore.IncludesShadersStore[inc.name] = inc.shader;
  }
}
...
var name9 = "spriteMapVertexShader";
var shader9 = `precision highp float;attribute vec3 position;attribute vec3 normal;attribute vec2 uv;varying vec3 vPosition;varying vec2 vUV;varying vec2 tUV;uniform float time;uniform mat4 world;uniform mat4 view;uniform mat4 projection;uniform vec2 stageSize;uniform float stageScale;
#include<fogVertexDeclaration>
#include<logDepthDeclaration>
...
var includes5 = [fogVertexDeclaration, logDepthDeclaration, logDepthVertex];
for (const inc of includes5) {
  if (!ShaderStore.IncludesShadersStore[inc.name]) {
    ShaderStore.IncludesShadersStore[inc.name] = inc.shader;
  }
}
...
export {
  ...
  DefaultRenderingPipelineParse,
  RegisterDefaultRenderingPipeline,
  SSAO2RenderingPipeline,
  SSAO2RenderingPipelineParse,
  RegisterSsao2RenderingPipeline,
  SSRRenderingPipeline,
  SSRRenderingPipelineParse,
  RegisterSsrRenderingPipeline,
  TAARenderingPipeline,
  TAARenderingPipelineParse,
  RegisterTaaRenderingPipeline,
...
//# sourceMappingURL=chunk-7HMPVU6T.js.map
