...
// node_modules/@babylonjs/core/ShadersWGSL/gaussianSplattingVoxel.fragment.js
var name = "gaussianSplattingVoxelPixelShader";
var shader = `var voxel_storage: texture_storage_3d<r8unorm,write>;varying vNormalizedPosition: vec3f;varying vNormalizedCenterPosition: vec3f;varying vAlpha: f32;varying vPatchPosition: vec2f;fn gsVoxelPrngCanonical1d(co: f32)->f32 {return fract(sin(co*91.3458)*47453.5453);}
...
var gaussianSplattingVoxelPixelShaderWGSL = { name, shader };
export {
  gaussianSplattingVoxelPixelShaderWGSL
};
//# sourceMappingURL=gaussianSplattingVoxel.fragment-IK4CNXYE.js.map
