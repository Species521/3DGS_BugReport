...
var shader = `#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
...
var includes = [helperFunctions, pbrBRDFFunctions, screenSpaceRayTrace];
for (const inc of includes) {
  if (!ShaderStore.IncludesShadersStore[inc.name]) {
    ShaderStore.IncludesShadersStore[inc.name] = inc.shader;
  }
}
var screenSpaceReflection2PixelShader = { name, shader };

export {
  screenSpaceReflection2PixelShader
};
//# sourceMappingURL=chunk-FMOT33NA.js.map
