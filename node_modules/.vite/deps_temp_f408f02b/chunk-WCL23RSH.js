...
// node_modules/@babylonjs/core/ShadersWGSL/lightProxy.vertex.js
var name = "lightProxyVertexShader";
var shader = `attribute position: vec3f;flat varying vOffset: u32;flat varying vMask: u32;
...
var includes = [sceneUboDeclarationWGSL, clusteredLightingFunctionsWGSL];
for (const inc of includes) {
  if (!ShaderStore.IncludesShadersStoreWGSL[inc.name]) {
    ShaderStore.IncludesShadersStoreWGSL[inc.name] = inc.shader;
  }
}
var lightProxyVertexShaderWGSL = { name, shader };

export {
  lightProxyVertexShaderWGSL
};
//# sourceMappingURL=chunk-WCL23RSH.js.map
