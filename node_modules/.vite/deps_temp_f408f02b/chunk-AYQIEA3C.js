...
var CubeMapToSphericalPolynomialTools = class {
  ...
  static ConvertCubeMapTextureToSphericalPolynomial(texture) {
    ...
    const rightPromise = texture.readPixels(0, mipLevel, void 0, false);
    const leftPromise = texture.readPixels(1, mipLevel, void 0, false);
    let upPromise;
    let downPromise;
    if (texture.isRenderTarget) {
      upPromise = texture.readPixels(3, mipLevel, void 0, false);
      downPromise = texture.readPixels(2, mipLevel, void 0, false);
    } else {
      upPromise = texture.readPixels(2, mipLevel, void 0, false);
      downPromise = texture.readPixels(3, mipLevel, void 0, false);
    }
    const frontPromise = texture.readPixels(4, mipLevel, void 0, false);
    const backPromise = texture.readPixels(5, mipLevel, void 0, false);
  ...
  static _DownsampleFace(data, srcSize, dstSize, stride) {
    ...
    const invArea = 1 / (blockSize * blockSize);
...
//# sourceMappingURL=chunk-AYQIEA3C.js.map
