...
var name = "screenSpaceReflection2BlurCombinerPixelShader";
var shader = `var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>; 
...
var includes = [helperFunctionsWGSL, pbrBRDFFunctionsWGSL, screenSpaceRayTraceWGSL];
for (const inc of includes) {
  if (!ShaderStore.IncludesShadersStoreWGSL[inc.name]) {
    ShaderStore.IncludesShadersStoreWGSL[inc.name] = inc.shader;
  }
}
var screenSpaceReflection2BlurCombinerPixelShaderWGSL = { name, shader };

export {
  screenSpaceReflection2BlurCombinerPixelShaderWGSL
};
//# sourceMappingURL=chunk-6NF6I7AA.js.map
