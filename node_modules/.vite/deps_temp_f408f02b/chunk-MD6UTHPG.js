...
var includes = [helperFunctionsWGSL, clipPlaneFragmentDeclarationWGSL, clipPlaneFragmentWGSL];
for (const inc of includes) {
  if (!ShaderStore.IncludesShadersStoreWGSL[inc.name]) {
    ShaderStore.IncludesShadersStoreWGSL[inc.name] = inc.shader;
  }
}
var glowMapGenerationPixelShaderWGSL = { name, shader };

export {
  glowMapGenerationPixelShaderWGSL
};
//# sourceMappingURL=chunk-MD6UTHPG.js.map
