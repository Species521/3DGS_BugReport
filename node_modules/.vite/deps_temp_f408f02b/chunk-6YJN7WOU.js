...
var pbrFragmentExtraDeclaration = { name, shader };
...
var shader2 = `bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;
if (!ShaderStore.IncludesShadersStore[name2]) {
  ShaderStore.IncludesShadersStore[name2] = shader2;
}
var subSurfaceScatteringFunctions = { name: name2, shader: shader2 };
...
var pbrHelperFunctions = { name: name3, shader: shader3 };
...
var pbrDirectLightingSetupFunctions = { name: name4, shader: shader4 };
...
var shader5 = `float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
var pbrDirectLightingFalloffFunctions = { name: name5, shader: shader5 };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/pbrDirectLightingFunctions.js
var name6 = "pbrDirectLightingFunctions";
var shader6 = `#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
var pbrDirectLightingFunctions = { name: name6, shader: shader6 };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/pbrBlockNormalGeometric.js
var name7 = "pbrBlockNormalGeometric";
var shader7 = `vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
var pbrBlockNormalGeometric = { name: name7, shader: shader7 };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/pbrBlockImageProcessing.js
var name8 = "pbrBlockImageProcessing";
var shader8 = `#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
var pbrBlockImageProcessing = { name: name8, shader: shader8 };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/pbrDebug.js
var name9 = "pbrDebug";
var shader9 = `#if DEBUGMODE>0
...
var pbrDebug = { name: name9, shader: shader9 };
...
//# sourceMappingURL=chunk-6YJN7WOU.js.map
