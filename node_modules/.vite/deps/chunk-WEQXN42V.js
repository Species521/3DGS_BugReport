...
var includes = [helperFunctions, clipPlaneFragmentDeclaration, clipPlaneFragment];
for (const inc of includes) {
  if (!ShaderStore.IncludesShadersStore[inc.name]) {
    ShaderStore.IncludesShadersStore[inc.name] = inc.shader;
  }
}
var glowMapGenerationPixelShader = { name, shader };

export {
  glowMapGenerationPixelShader
};
//# sourceMappingURL=chunk-WEQXN42V.js.map
