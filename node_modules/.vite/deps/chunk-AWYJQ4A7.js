...
var name = "iblVoxelGridVertexShader";
var shader = `#include <bakedVertexAnimationDeclaration>
...
var includes = [morphTargetsVertexGlobalDeclarationWGSL, morphTargetsVertexDeclarationWGSL, vertexPullingDeclarationWGSL, bonesVertexWGSL, bakedVertexAnimationWGSL];
for (const inc of includes) {
  if (!ShaderStore.IncludesShadersStoreWGSL[inc.name]) {
    ShaderStore.IncludesShadersStoreWGSL[inc.name] = inc.shader;
  }
}
var iblVoxelGridVertexShaderWGSL = { name, shader };

export {
  iblVoxelGridVertexShaderWGSL
};
//# sourceMappingURL=chunk-AWYJQ4A7.js.map
