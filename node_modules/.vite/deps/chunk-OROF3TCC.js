...
// node_modules/@babylonjs/core/Materials/effect.pure.js
var _a;
var _b;
var _c;
...
(_a = Effect.prototype).setDepthStencilTexture ?? (_a.setDepthStencilTexture = _MissingSideEffect("Effect", "setDepthStencilTexture"));
(_b = Effect.prototype).setTextureFromPostProcess ?? (_b.setTextureFromPostProcess = _MissingSideEffect("Effect", "setTextureFromPostProcess"));
(_c = Effect.prototype).setTextureFromPostProcessOutput ?? (_c.setTextureFromPostProcessOutput = _MissingSideEffect("Effect", "setTextureFromPostProcessOutput"));
...
// node_modules/@babylonjs/core/Engines/abstractEngine.pure.js
var _a2;
var _b2;
var _c2;
var _d;
...
var AbstractEngine = class _AbstractEngine {
  ...
  _rebuildRenderTargetWrappers() {
    ...
    for (const renderTargetWrapper of currentState) {
      if (renderTargetWrapper.textures?.some(
        (t) => t.source === 15
    ...
    if (loaderPromise) {
      ...
      if (!fromData || isBase64) {
        if (buffer && (typeof buffer.decoding === "string" || buffer.close)) {
          ...
          LoadImage(url || "", onload, onInternalError, scene ? scene.offlineProvider : null, mimeType, texture.invertY && this._features.needsInvertingBitmap ? { imageOrientation: "flipY" } : void 0, this);
        }
      } else if (typeof buffer === "string" || buffer instanceof ArrayBuffer || ArrayBuffer.isView(buffer) || buffer instanceof Blob) {
        LoadImage(buffer, onload, onInternalError, scene ? scene.offlineProvider : null, mimeType, texture.invertY && this._features.needsInvertingBitmap ? { imageOrientation: "flipY" } : void 0, this);
      } else if (buffer) {
        onload(buffer);
      }
    }
...
(_a2 = AbstractEngine.prototype).setAlphaEquation ?? (_a2.setAlphaEquation = _MissingSideEffect("AbstractEngine", "setAlphaEquation"));
(_b2 = AbstractEngine.prototype).createCubeTextureBase ?? (_b2.createCubeTextureBase = _MissingSideEffect("AbstractEngine", "createCubeTextureBase"));
(_c2 = AbstractEngine.prototype).getInputElement ?? (_c2.getInputElement = _MissingSideEffect("AbstractEngine", "getInputElement"));
...
//# sourceMappingURL=chunk-OROF3TCC.js.map
