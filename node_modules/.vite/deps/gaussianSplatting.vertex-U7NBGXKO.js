...
} from "./chunk-REMPSIR4.js";
import {
  gaussianSplattingVertexDeclaration
} from "./chunk-QF62IPNO.js";
import {
  gaussianSplatting
} from "./chunk-PXV4B5V5.js";
import {
  meshUboDeclaration
...
var name = "gaussianSplattingVertexShader";
var shader = `#include<__decl__gaussianSplattingVertex>
...
var includes = [gaussianSplattingVertexDeclaration, sceneUboDeclaration, meshUboDeclaration, gaussianSplattingUboDeclaration, clipPlaneVertexDeclaration, fogVertexDeclaration, logDepthDeclaration, helperFunctions, gaussianSplatting, clipPlaneVertex, fogVertex, logDepthVertex];
for (const inc of includes) {
  if (!ShaderStore.IncludesShadersStore[inc.name]) {
    ShaderStore.IncludesShadersStore[inc.name] = inc.shader;
  }
}
var gaussianSplattingVertexShader = { name, shader };
export {
  gaussianSplattingVertexShader
};
//# sourceMappingURL=gaussianSplatting.vertex-U7NBGXKO.js.map
