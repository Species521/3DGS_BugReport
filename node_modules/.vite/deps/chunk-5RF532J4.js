...
var shader = `attribute position: vec4f;attribute options: vec2f;attribute offsets: vec2f;attribute inverts: vec2f;attribute cellInfo: vec4f;attribute color: vec4f;uniform view: mat4x4f;uniform projection: mat4x4f;varying vUV: vec2f;varying vColor: vec4f;
...
var includes = [fogVertexDeclarationWGSL, logDepthDeclarationWGSL, logDepthVertexWGSL];
for (const inc of includes) {
  if (!ShaderStore.IncludesShadersStoreWGSL[inc.name]) {
    ShaderStore.IncludesShadersStoreWGSL[inc.name] = inc.shader;
  }
}
var spritesVertexShaderWGSL = { name, shader };

export {
  spritesVertexShaderWGSL
};
//# sourceMappingURL=chunk-5RF532J4.js.map
