...
var name = "volumetricLightingRenderVolumePixelShader";
var shader = `#include<__decl__sceneFragment>
...
var includes = [sceneFragmentDeclaration, sceneUboDeclaration];
for (const inc of includes) {
  if (!ShaderStore.IncludesShadersStore[inc.name]) {
    ShaderStore.IncludesShadersStore[inc.name] = inc.shader;
  }
}
var volumetricLightingRenderVolumePixelShader = { name, shader };
export {
  volumetricLightingRenderVolumePixelShader
};
//# sourceMappingURL=volumetricLightingRenderVolume.fragment-T3GV4GDJ.js.map
