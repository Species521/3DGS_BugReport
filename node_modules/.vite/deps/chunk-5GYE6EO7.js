...
var name = "intersectionFunctions";
var shader = `fn diskIntersectWithBackFaceCulling(ro: vec3f,rd: vec3f,c: vec3f,r: f32)->f32 {var d: f32=rd.y;if(d>0.0) { return 1e6; }
...
var intersectionFunctionsWGSL = { name, shader };

// node_modules/@babylonjs/core/ShadersWGSL/background.fragment.js
var name2 = "backgroundPixelShader";
var shader2 = `#include<backgroundUboDeclaration>
...
var includes = [sceneUboDeclarationWGSL, backgroundUboDeclarationWGSL, helperFunctionsWGSL, reflectionFunctionWGSL, imageProcessingDeclarationWGSL, lightUboDeclarationWGSL, ltcHelperFunctionsWGSL, clusteredLightingFunctionsWGSL, lightsFragmentFunctionsWGSL, shadowsFragmentFunctionsWGSL, imageProcessingFunctionsWGSL, logDepthDeclarationWGSL, clipPlaneFragmentDeclarationWGSL, fogFragmentDeclarationWGSL, intersectionFunctionsWGSL, clipPlaneFragmentWGSL, lightFragmentWGSL, logDepthFragmentWGSL, fogFragmentWGSL];
for (const inc of includes) {
  if (!ShaderStore.IncludesShadersStoreWGSL[inc.name]) {
    ShaderStore.IncludesShadersStoreWGSL[inc.name] = inc.shader;
  }
}
var backgroundPixelShaderWGSL = { name: name2, shader: shader2 };

export {
  intersectionFunctionsWGSL,
  backgroundPixelShaderWGSL
};
//# sourceMappingURL=chunk-5GYE6EO7.js.map
