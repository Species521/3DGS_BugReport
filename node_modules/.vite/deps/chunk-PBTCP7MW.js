import {
  ...
  openpbrGeometryInfo,
  openpbrIblFunctions,
  openpbrSubsurfaceLayerData,
  openpbrTransmissionLayerData
} from "./chunk-IFIEOX4A.js";
import {
  openpbrUboDeclaration
} from "./chunk-VQDIORSA.js";
import {
...
} from "./chunk-6YJN7WOU.js";
import {
  hdrFilteringFunctions,
  importanceSampling
} from "./chunk-NYSO6DCE.js";
import {
  pbrFragmentReflectionDeclaration,
  pbrIBLFunctions
} from "./chunk-AA7727K4.js";
import {
  harmonicsFunctions
} from "./chunk-VOJ7265K.js";
import {
  sceneFragmentDeclaration
} from "./chunk-QLHJUOGH.js";
import {
  pbrBRDFFunctions
} from "./chunk-2CG2XAIR.js";
import {
  ...
  oitFragment,
  prePassDeclaration,
  textureRepetitionFunctions
} from "./chunk-W7XA34YO.js";
import {
  samplerFragmentDeclaration
} from "./chunk-OE7KVARA.js";
import {
  lightFragmentDeclaration
} from "./chunk-QVF4Y4NF.js";
import {
  lightUboDeclaration
} from "./chunk-K4S2Q5V7.js";
import {
  ltcHelperFunctions
} from "./chunk-DLSRH7DH.js";
import {
  shadowsFragmentFunctions
} from "./chunk-HKZ7AAFX.js";
import {
  reflectionFunction
} from "./chunk-SUPV3ZYH.js";
import {
  mainUVVaryingDeclaration
} from "./chunk-5JEEVUHG.js";
import {
  meshUboDeclaration
} from "./chunk-ZZ4ZID2A.js";
import {
  sceneUboDeclaration
...
var openpbrFragmentDeclaration = { name, shader };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrFragmentSamplersDeclaration.js
var name2 = "openpbrFragmentSamplersDeclaration";
var shader2 = `#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
var openpbrFragmentSamplersDeclaration = { name: name2, shader: shader2 };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrNormalMapFragmentMainFunctions.js
var name3 = "openpbrNormalMapFragmentMainFunctions";
var shader3 = `#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
var openpbrNormalMapFragmentMainFunctions = { name: name3, shader: shader3 };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrNormalMapFragmentFunctions.js
var name4 = "openpbrNormalMapFragmentFunctions";
var shader4 = `#if defined(GEOMETRY_NORMAL)
...
var openpbrNormalMapFragmentFunctions = { name: name4, shader: shader4 };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrConductorReflectance.js
var name5 = "openpbrConductorReflectance";
var shader5 = `#define pbr_inline
...
var openpbrConductorReflectance = { name: name5, shader: shader5 };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrAmbientOcclusionFunctions.js
var name6 = "openpbrAmbientOcclusionFunctions";
var shader6 = `float compute_specular_occlusion(const float n_dot_v,const float metallic,const float ambient_occlusion,const float roughness)
...
var openpbrAmbientOcclusionFunctions = { name: name6, shader: shader6 };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrVolumeFunctions.js
var name7 = "openpbrVolumeFunctions";
var shader7 = `struct OpenPBRHomogeneousVolume {vec3 extinction_coeff; 
vec3 ss_albedo; 
...
var openpbrVolumeFunctions = { name: name7, shader: shader7 };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrNormalMapFragment.js
var name8 = "openpbrNormalMapFragment";
var shader8 = `vec2 uvOffset=vec2(0.0,0.0);
...
var openpbrNormalMapFragment = { name: name8, shader: shader8 };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrBlockNormalFinal.js
var name9 = "openpbrBlockNormalFinal";
var shader9 = `#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
var openpbrBlockNormalFinal = { name: name9, shader: shader9 };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrBaseLayerData.js
var name10 = "openpbrBaseLayerData";
var shader10 = `vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);float geometry_thickness=0.0;
#ifdef BASE_WEIGHT
...
var openpbrBaseLayerData = { name: name10, shader: shader10 };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrCoatLayerData.js
var name11 = "openpbrCoatLayerData";
var shader11 = `float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
var openpbrCoatLayerData = { name: name11, shader: shader11 };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrThinFilmLayerData.js
var name12 = "openpbrThinFilmLayerData";
var shader12 = `#ifdef THIN_FILM
...
var openpbrThinFilmLayerData = { name: name12, shader: shader12 };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrFuzzLayerData.js
var name13 = "openpbrFuzzLayerData";
var shader13 = `float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
var openpbrFuzzLayerData = { name: name13, shader: shader13 };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrAmbientOcclusionData.js
var name14 = "openpbrAmbientOcclusionData";
var shader14 = `vec3 ambient_occlusion=vec3(1.0);float specular_ambient_occlusion=1.0;float coat_specular_ambient_occlusion=1.0;
#ifdef AMBIENT_OCCLUSION
...
var openpbrAmbientOcclusionData = { name: name14, shader: shader14 };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrBackgroundTransmission.js
var name15 = "openpbrBackgroundTransmission";
var shader15 = `vec4 slab_translucent_background=vec4(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
var openpbrBackgroundTransmission = { name: name15, shader: shader15 };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrEnvironmentLighting.js
var name16 = "openpbrEnvironmentLighting";
var shader16 = `#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
var openpbrEnvironmentLighting = { name: name16, shader: shader16 };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrDirectLightingInit.js
var name17 = "openpbrDirectLightingInit";
...
var openpbrDirectLightingInit = { name: name17, shader: shader17 };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrDirectLighting.js
var name18 = "openpbrDirectLighting";
var shader18 = `#ifdef LIGHT{X}
...
var openpbrDirectLighting = { name: name18, shader: shader18 };

// node_modules/@babylonjs/core/Shaders/ShadersInclude/openpbrBlockPrePass.js
var name19 = "openpbrBlockPrePass";
var shader19 = `#if SCENE_MRT_COUNT>0
...
var openpbrBlockPrePass = { name: name19, shader: shader19 };

// node_modules/@babylonjs/core/Shaders/openpbr.fragment.js
var name20 = "openpbrPixelShader";
var shader20 = `#define OPENPBR_FRAGMENT_SHADER
