...
var includes = [sceneUboDeclarationWGSL, meshUboDeclarationWGSL];
for (const inc of includes) {
  if (!ShaderStore.IncludesShadersStoreWGSL[inc.name]) {
    ShaderStore.IncludesShadersStoreWGSL[inc.name] = inc.shader;
  }
}
var volumetricLightingRenderVolumePixelShaderWGSL = { name, shader };
export {
  volumetricLightingRenderVolumePixelShaderWGSL
};
//# sourceMappingURL=volumetricLightingRenderVolume.fragment-HTRYZY6E.js.map
