...
var ThinPassPostProcess = class _ThinPassPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      ...
      list.push(Promise.all([import("./pass.fragment-DZXAVC25.js")]));
    } else {
      list.push(Promise.all([import("./pass.fragment-QUNGZN43.js")]));
    }
...
var ThinPassCubePostProcess = class _ThinPassCubePostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(Promise.all([import("./passCube.fragment-GATVAYZY.js")]));
    } else {
      list.push(Promise.all([import("./passCube.fragment-FMUKLMBK.js")]));
    }
    super._gatherImports(useWebGPU, list);
  }
  /**
...
// node_modules/@babylonjs/core/PostProcesses/passPostProcess.pure.js
...
async function ReadPixelsUsingRTT(texture, width, height, face, lod, slice = 0) {
  ...
  if (!engine.isWebGPU) {
    if (is3DTexture) {
      await import("./lod3D.fragment-OXOTORI2.js");
    } else if (texture.isCube) {
      await import("./lodCube.fragment-7G55LUOX.js");
    } else {
      await import("./lod.fragment-A3TUQYDS.js");
    }
  } else {
    if (is3DTexture) {
      await import("./lod3D.fragment-F56LLH2D.js");
    } else if (texture.isCube) {
      await import("./lodCube.fragment-6EWVELRX.js");
    } else {
      await import("./lod.fragment-NBWSOSJS.js");
    }
  }
  let lodPostProcess;
  if (is3DTexture) {
...
async function GetTextureDataAsync(texture, width, height, face = 0, lod = 0, forceRTT = false, slice = 0) {
...
//# sourceMappingURL=chunk-OVO7JWF5.js.map
