...
var name = "greasedLineVertexShader";
...
var includes = [instancesDeclaration, instancesVertex];
for (const inc of includes) {
  if (!ShaderStore.IncludesShadersStore[inc.name]) {
    ShaderStore.IncludesShadersStore[inc.name] = inc.shader;
  }
}
var greasedLineVertexShader = { name, shader };

export {
  greasedLineVertexShader
};
//# sourceMappingURL=chunk-75MRB2CG.js.map
