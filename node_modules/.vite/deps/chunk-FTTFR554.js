...
var shadowMapVertexExtraDeclarationWGSL = { name, shader };
...
var shadowMapVertexNormalBiasWGSL = { name: name2, shader: shader2 };
...
var includes = [bonesDeclarationWGSL, bakedVertexAnimationDeclarationWGSL, morphTargetsVertexGlobalDeclarationWGSL, morphTargetsVertexDeclarationWGSL, helperFunctionsWGSL, sceneUboDeclarationWGSL, meshUboDeclarationWGSL, shadowMapVertexExtraDeclarationWGSL, clipPlaneVertexDeclarationWGSL, morphTargetsVertexGlobalWGSL, morphTargetsVertexWGSL, instancesVertexWGSL, bonesVertexWGSL, bakedVertexAnimationWGSL, shadowMapVertexNormalBiasWGSL, shadowMapVertexMetricWGSL, clipPlaneVertexWGSL];
for (const inc of includes) {
  if (!ShaderStore.IncludesShadersStoreWGSL[inc.name]) {
    ShaderStore.IncludesShadersStoreWGSL[inc.name] = inc.shader;
  }
}
var shadowMapVertexShaderWGSL = { name: name3, shader: shader3 };

export {
  shadowMapVertexShaderWGSL
};
//# sourceMappingURL=chunk-FTTFR554.js.map
