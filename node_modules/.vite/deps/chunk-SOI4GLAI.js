...
} from "./chunk-3CTDKUPM.js";
import {
  packingFunctionsWGSL
} from "./chunk-7WYLRBHZ.js";
import {
...
var bayerDitherFunctionsWGSL = { name, shader };
...
var shadowMapFragmentExtraDeclarationWGSL = { name: name2, shader: shader2 };
...
var includes = [packingFunctionsWGSL, bayerDitherFunctionsWGSL, shadowMapFragmentExtraDeclarationWGSL, clipPlaneFragmentDeclarationWGSL, clipPlaneFragmentWGSL, shadowMapFragmentWGSL];
for (const inc of includes) {
  if (!ShaderStore.IncludesShadersStoreWGSL[inc.name]) {
    ShaderStore.IncludesShadersStoreWGSL[inc.name] = inc.shader;
  }
}
var shadowMapPixelShaderWGSL = { name: name3, shader: shader3 };

export {
  shadowMapPixelShaderWGSL
};
//# sourceMappingURL=chunk-SOI4GLAI.js.map
