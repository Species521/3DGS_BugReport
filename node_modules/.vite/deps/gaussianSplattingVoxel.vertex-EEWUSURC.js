...
// node_modules/@babylonjs/core/ShadersWGSL/gaussianSplattingVoxel.vertex.js
...
var includes = [sceneUboDeclarationWGSL, meshUboDeclarationWGSL, gaussianSplattingWGSL];
for (const inc of includes) {
  if (!ShaderStore.IncludesShadersStoreWGSL[inc.name]) {
    ShaderStore.IncludesShadersStoreWGSL[inc.name] = inc.shader;
  }
}
var gaussianSplattingVoxelVertexShaderWGSL = { name, shader };
export {
  gaussianSplattingVoxelVertexShaderWGSL
};
//# sourceMappingURL=gaussianSplattingVoxel.vertex-EEWUSURC.js.map
