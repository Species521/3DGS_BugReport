...
export function configureMeshDistanceOrScreenCoverage(scene) {
 ...
 */
export function applyMeshesLODQuality(quality, scene) {
    scene.meshes.forEach((mesh) => {
        if (!isMesh(mesh)) {
            return;
        }
 ...
 */
export function isDecalMesh(mesh) {
 ...
 */
export function setStaticDecalsEnabled(enabled, scene) {
    scene.meshes.forEach((mesh) => {
