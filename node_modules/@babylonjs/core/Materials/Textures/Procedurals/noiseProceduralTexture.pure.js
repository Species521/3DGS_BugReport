...
let _NoiseProceduralTextureShaderPromise;
async function _EnsureNoiseProceduralTextureShaderAsync() {
    _NoiseProceduralTextureShaderPromise ?? (_NoiseProceduralTextureShaderPromise = (async () => {
 ...
 */
export function RegisterNoiseProceduralTexture() {
    if (_Registered) {
        return;
    }
    _Registered = true;
...
//# sourceMappingURL=noiseProceduralTexture.pure.js.map