...
import { type Nullable, type DataArray, type FloatArray } from "../types.js";
 ...
 */
export declare function VertexBufferDeduceStride(kind: string): number;
/**
 * Gets the vertex buffer type of the given data array.
 * @param data the data array
 * @returns the vertex buffer type
 */
export declare function VertexBufferGetDataType(data: DataArray): number;
/**
 ...
 */
export declare function VertexBufferGetTypeByteLength(type: number): number;
/**
 ...
 */
export declare function VertexBufferForEach(data: DataArray, byteOffset: number, byteStride: number, componentCount: number, componentType: number, count: number, normalized: boolean, callback: (value: number, index: number) => void): void;
/**
 ...
 */
export declare function VertexBufferGetFloatData(data: DataArray, size: number, type: number, byteOffset: number, byteStride: number, normalized: boolean, totalVertices: number, forceCopy?: boolean): FloatArray;
/**
 * Register side effects for VertexBuffer.
 * Safe to call multiple times; only the first call has an effect.
 */
export declare function RegisterVertexBuffer(): void;
