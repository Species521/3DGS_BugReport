...
export const supportedImagesExtensions = [".jpg", ".jpeg", ".webp", ".png", ".bmp"];
export const supportedCubeTexturesExtensions = [".env", ".dds", ".hdr"];
export const supportedAudioExtensions = [".mp3", ".wav", ".wave", ".ogg"];
export const supportedJsonExtensions = [".material", ".gui", ".cinematic", ".npss", ".ragdoll", ".json"];
export const supportedMiscExtensions = [".3dl", ".exr", ".hdr"];
...
export async function processAssetFile(file, options) {
