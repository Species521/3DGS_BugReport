const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/textureProcessor.fragment-CcOeeBHf.js","assets/index-BCisiVAF.js","assets/index-DmJM_uIj.css","assets/textureProcessor.fragment-LzSaLSRg.js"])))=>i.map(i=>d[i]);
import { al as Color4, am as ProceduralTexture, an as __vitePreload, a as Color3 } from './index-BCisiVAF.js';
    ...
    const options = {
        ...
        extraInitializationsAsync: async () => {
            if (scene.getEngine().isWebGPU) {
                await Promise.all([__vitePreload(() => import('./textureProcessor.fragment-CcOeeBHf.js'),true              ?__vite__mapDeps([0,1,2]):void 0)]);
            }
            else {
                await Promise.all([__vitePreload(() => import('./textureProcessor.fragment-LzSaLSRg.js'),true              ?__vite__mapDeps([3,1,2]):void 0)]);
            }
        },
