const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/textureProcessor.fragment-CO_--bvm.js","assets/index-C8NnqHWK.js","assets/index-DmJM_uIj.css","assets/textureProcessor.fragment-Bhad9kVs.js"])))=>i.map(i=>d[i]);
import { al as Color4, am as ProceduralTexture, an as __vitePreload, a as Color3 } from './index-C8NnqHWK.js';
    ...
    const options = {
        ...
        extraInitializationsAsync: async () => {
            if (scene.getEngine().isWebGPU) {
                await Promise.all([__vitePreload(() => import('./textureProcessor.fragment-CO_--bvm.js'),true              ?__vite__mapDeps([0,1,2]):void 0)]);
            }
            else {
                await Promise.all([__vitePreload(() => import('./textureProcessor.fragment-Bhad9kVs.js'),true              ?__vite__mapDeps([3,1,2]):void 0)]);
            }
        },
