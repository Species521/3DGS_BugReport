const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/textureProcessor.fragment-B2MsqovD.js","assets/index-Cp0TDIpt.js","assets/index-DSePEkmy.css","assets/textureProcessor.fragment-BRbFnHzG.js"])))=>i.map(i=>d[i]);
import { al as Color4, am as ProceduralTexture, an as __vitePreload, a as Color3 } from './index-Cp0TDIpt.js';
    ...
    const options = {
        ...
        extraInitializationsAsync: async () => {
            if (scene.getEngine().isWebGPU) {
                await Promise.all([__vitePreload(() => import('./textureProcessor.fragment-B2MsqovD.js'),true              ?__vite__mapDeps([0,1,2]):void 0)]);
            }
            else {
                await Promise.all([__vitePreload(() => import('./textureProcessor.fragment-BRbFnHzG.js'),true              ?__vite__mapDeps([3,1,2]):void 0)]);
            }
        },
